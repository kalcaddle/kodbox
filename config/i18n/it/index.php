...
return array(
    ...
    "admin.menu.groupMember"         => "Gestione utenti e gruppi",
    ...
    "admin.index.spaceUse"           => "Spazio utilizzato",
    "admin.index.spaceSave"          => "Spazio risparmiato",
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "Lunghezza maggiore di 6 caratteri; deve contenere sia lettere che numeri; maiuscole e minuscole",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.storage.defaultDesc"      => "Se abilitato, diventerà lo spazio di archiviazione predefinito. Quello attuale verrà annullato. (Procedere con cautela)",
    ...
    "admin.storage.ftpPasvOn"        => "Accendere",
    "admin.storage.ftpPasvOff"       => "chiusura",
    ...
    "admin.task.isOpen"              => "Abilitazione",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "admin.setting.shareLinkZipDesc" => "Attiva il download, sottoforma di pacchetti compressi, delle cartelle condivise esternamente tramite link. Attenzione, se le dimensioni sono eccessive, le prestazioni del server ne risentiranno.",
    ...
    "explorer.share.linkTo"          => "Condividi esternamente",
    ...
    "explorer.share.openOuterLinkDesc" => "Dopo aver creato un collegamento esterno, è possibile inviarlo ad altri via e-mail oppure altre apps.",
    ...
    "explorer.tag.addTo"             => "Aggiungi etichetta",
    ...
    "user.userNickName"              => "Nickname personale",
    ...
    "log-event-create-mkfile-item"   => "Creato [2] creato in [1]",
    ...
    "log-event-recycle-toRecycle-more" => "Spostati [1] documenti nel Cestino",
    "log-event-recycle-toRecycle-more-at" => "Spostato [2] documenti su [1] nel Cestino",
    "log-event-recycle-restore"      => "Ripristina il documento dal cestino",
    "log-event-recycle-restore-item" => "Ripristinato [1] dal cestino",
    "log-event-recycle-restore-more" => "Ripristinati [1] documenti dal cestino",
