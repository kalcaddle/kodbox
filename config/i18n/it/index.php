...
return array(
    ...
    "admin.menu.storageDriver"       => "Archiviazione",
...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.encodeTips2"      => "Per evitare errori, non eliminare o rinominare i file nei data/files;",
    ...
    "admin.setting.globalHtml"       => "Codice HTML statistico",
    ...
    "admin.setting.shareToMeAllowTree" => "Collabora con me-mostra per struttura organizzativa",
    "admin.setting.shareToMeAllowTreeTips" => "Dopo l'apertura, il supporto dei contenuti per la collaborazione con me è classificato in base alla struttura organizzativa del dipartimento, che è adatta a situazioni in cui la struttura organizzativa è più complessa",
    "admin.setting.groupTagAllow"    => "Etichetta pubblica del dipartimento",
    "admin.setting.groupTagAllowTips" => "Dopo l'abilitazione, tutti i membri del dipartimento saranno visibili dopo aver impostato l'etichetta pubblica per i file nel dipartimento.L'amministratore del dipartimento può mantenere il contenuto dell'etichetta.",
    "admin.setting.shareToMeList"    => "Display piastrellato",
    ...
    "admin.group.authShow"           => "L'ambito della struttura organizzativa visibile ai membri del dipartimento",
    "admin.group.authShowAll"        => "Tutti i reparti",
    "admin.group.authShowHide"       => "Solo questo dipartimento e sotto-dipartimento",
    "admin.group.authShowSelect"     => "Reparto designato",
    "admin.group.authShowAllTips"    => "Quando i membri di questo reparto collaborano per condividere, possono selezionare tutti gli altri reparti (e utenti)",
    "admin.group.authShowHideTips"   => "Quando i membri di questo dipartimento collaborano e condividono, sono supportati solo il dipartimento e il sottoreparto correnti (e gli utenti)",
    "admin.group.authShowSelectTips" => "Quando i membri del dipartimento collaborano e condividono, possono selezionare il dipartimento designato e il sottoreparto (e l'utente), inclusi il dipartimento e il sottoreparto correnti",
    ...
    "admin.role.group"               => "Amministratore di dipartimento",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.backup.contentDesc"       => "La versione con licenza supporta il backup simultaneo di database e file",
    "admin.backup.action"            => "Gestione operativa",
    "admin.backup.recovery"          => "riduzione",
    "admin.backup.sysRecovery"       => "ripristino del sistema",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "admin.setting.transferDownSpeedNumDesc" => "Limit a la velocità di download. In caso di grande concorrenza del sito web, può essere imposto un limite di velocità unificato. <br/> nota: la velocità del server è limitata qui. La velocità di download specifica è anche relativa alla larghezza di banda del server e alla rete utente",
    ...
    "common.confirmTips"             => "Si prega di confermare di nuovo",
    ...
    "explorer.pastSuccess"           => "Incolla completata operazione",
    "explorer.cutePastSuccess"       => "L'operazione di taglio è completata",
    ...
    "explorer.ifSaveFileTips"        => "Alcuni file non sono stati salvati. Sei sicuro di chiudere la finestra?",
 ...
 L'autorizzazione all'operazione viene assegnata e impostata dall'amministratore del reparto.",
    ...
    "explorer.pathDesc.shareToMe"    => "Display piastrellato: tutti i contenuti con cui ho collaborato",
 ...
 Supporta pinyin, corrispondenza fuzzy della prima lettera",
    ...
    "explorer.share.shareToTarget"   => "Membro collaboratore",
    ...
    "explorer.tag.filter"            => "Filtra per etichetta",
    "explorer.groupTag.title"        => "Etichetta pubblica",
    "explorer.groupTag.menuTtitle"   => "Etichetta pubblica del dipartimento",
    "explorer.groupTag.titleDesc"    => "Etichetta pubblica all'interno del dipartimento",
    "explorer.groupTag.empty"        => "Dopo che l'amministratore del dipartimento ha impostato l'etichetta pubblica, viene automaticamente abilitata.Quando non è presente alcun contenuto di etichetta, l'etichetta pubblica viene automaticamente disattivata!",
    "explorer.tag.pathDesc"          => "Filtra per etichetta personale",
    "explorer.groupTag.pathDesc"     => "Filtra per etichetta pubblica del dipartimento",
    "explorer.groupTag.removeTypeTips" => "Eliminare questo gruppo? Tutti i documenti associati all'etichetta verranno rimossi dopo l'eliminazione!",
    "explorer.groupTag.removeTagTips" => "Sei sicuro di voler eliminare il tag? Il documento associato al tag verrà rimosso dopo l'eliminazione!",
    "explorer.groupTag.typeAdd"      => "Aggiungi categoria",
    "explorer.groupTag.typeName"     => "Nome della categoria",
    "explorer.groupTag.addDesc"      => "Dopo aver aggiunto i tag, i tag di reparto vengono abilitati automaticamente e il numero massimo di tag è 1000",
