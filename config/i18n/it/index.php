...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Accedi all'ID chiave dell'account Huawei Cloud, crealo o visualizzalo in [Console-Le mie credenziali-Credenziali API]",
    "admin.storage.obsSecretDesc"    => "Accedi alla chiave segreta dell'account Huawei Cloud, il metodo per ottenerla è lo stesso sopra",
    "admin.storage.bosKeyDesc"       => "ID chiave di accesso dell'account Baidu Cloud, crealo o visualizzalo in [Console-Autenticazione di sicurezza-Chiave di accesso]",
    "admin.storage.bosSecretDesc"    => "Accedi alla chiave segreta dell'account Baidu Cloud, il metodo per ottenerla è lo stesso sopra",
