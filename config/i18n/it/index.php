...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.sysRecTab"        => "Recupero database",
    ...
    "admin.setting.ifSaveDb"         => "Lo switch del database importerà i dati correnti del sistema nel nuovo database e lo imposterà come predefinito.<br> Sei sicuro di volerlo eseguire?",
    ...
    "admin.setting.dbTaskDesc"       => "Non chiudere la finestra o eseguire altre operazioni nel sistema per evitare di generare dati di discrepanza.",
    "admin.setting.recTaskDesc"      => "Non chiudere la finestra Dopo l'interruzione della richiesta, lo sfondo continuerà a essere eseguito fino al termine dell'attività.",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.backup.optionLocation"    => "Se è necessario eseguire il backup dei file, creare un nuovo spazio di archiviazione dedicato al backup",
