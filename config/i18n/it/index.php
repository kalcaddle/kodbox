...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.group.swtichDesc"         => "Migrare utenti e file dal reparto selezionato al reparto di destinazione",
    ...
    "admin.member.groupSwtichDesc"   => "Migra gli utenti selezionati dal dipartimento corrente al dipartimento di destinazione",
    ...
    "admin.member.importEmail"       => "E-mail (solo)",
    ...
    "admin.member.authCopy"          => "Autorizzazioni del reparto di copia",
    "admin.member.authPaste"         => "Incolla il permesso del dipartimento",
    "admin.member.ifAuthPaste"       => "Sei sicuro di voler impostare le autorizzazioni del reparto copiate per l'utente corrente?",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.storage.sizeDesc"         => "(GB), compilare in base allo spazio libero effettivo della directory di archiviazione selezionata",
    ...
    "admin.install.dbPortDesc"       => "La porta predefinita è 3306, se è necessario personalizzarla, è possibile aggiungerla, ad esempio: 127.0.0.1:3307",
    ...
    "admin.log.switchUserGroup"      => "Migrazione degli utenti ai reparti",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "explorer.photo.group"           => "Raggruppamento di album",
    ...
    "explorer.photo.fileSize"        => "filtro della dimensione del file",
 ...
 Supporta pinyin, corrispondenza fuzzy della prima lettera",
    ...
    "explorer.panel.thumbClear"      => "miniatura chiara",
    "explorer.panel.thumbClearDesc"  => "Cancella le miniature dei file, la copertina da rigenerare.",
    ...
    "explorer.filter.unzipSizeLimit" => "La dimensione del file di decompressione supera il limite; il massimo che puoi decomprimere è:",
    "explorer.filter.zipSizeLimit"   => "La dimensione del file compresso supera il limite; i tuoi documenti comprimibili massimi:",
