...
return array(
    ...
    "admin.menu.storage"             => "Gestione archiviazione",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.share.doRptDisable"       => "La modifica avrà effetto su utte le risorse corrispondenti al file condiviso.<br />Sei sicuro di voler effettuare questa operazione?",
    ...
    "admin.share.rptIfBatch"         => "Sei sicuro di voler procedere?",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "explorer.fileLog"               => "Registro file",
