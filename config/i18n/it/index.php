...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo1"     => "Scrivendo i dati nel file del database di backup nel nuovo database e impostandolo come predefinito del sistema, viene realizzato il ripristino dei dati.",
    "admin.setting.recDescInfo2"     => "I nuovi parametri di configurazione del database verranno aggiunti al file di configurazione del sistema config/setting_user.php Se il sistema è anomalo dopo l'esecuzione del ripristino, la parte aggiunta del file può essere rimossa senza influire sui dati di sistema precedenti.",
    "admin.setting.recDescInfo3"     => "Questa funzione supporta solo l'elaborazione dei dati di backup generati dalla gestione del backup del sistema e il database di cui si è eseguito il backup deve essere elaborato in altri modi.",
