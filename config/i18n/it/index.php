...
return array(
    ...
    "admin.menu.groupMember"         => "Gestione dipartimenti e membri",
    "admin.menu.member"              => "Dipartimenti ed utenti",
    "admin.menu.role"                => "Ruoli",
    "admin.menu.job"                 => "Gestione del lavoro",
    "admin.menu.auth"                => "Autorizzazioni e gruppi",
...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.icpDesc"          => "Se devi generare un link, puoi aggiungere tu stesso un'etichetta",
    ...
    "admin.setting.autoLoginDesc"    => "L'utente di accesso predefinito è l'utente <code>guest/guest</code>, assicurarsi che questo utente esista dopo averlo abilitato",
    ...
    "admin.member.group"             => "Reparto di appartenenza",
    ...
    "admin.auth.download"            => "Scarica e copia",
    "admin.auth.downloadAction"      => "Scarica / Copia / Visualizza anteprima file",
    ...
    "admin.auth.shareAction"         => "Condivisione tramite link / Condivisione e collaborazione con altri utenti",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "explorer.ifSaveFileTips"        => "Salvare le modifiche apportate?",
    ...
    "explorer.openIE"                => "Apre nel browser",
    ...
    "explorer.urlLink"               => "URL diretto esterno",
    ...
    "explorer.file.shareTime"        => "Tempo di condivisione",
    ...
    "explorer.share.name"            => "Nome file condiviso",
    ...
    "explorer.share.downNum"         => "Download del file",
    ...
    "explorer.share.linkTo"          => "Condividisione tramite link",
    ...
    "explorer.share.openOuterLink"   => "Condivisione file",
    ...
    "log-event-move-current"         => "Sposta [1] da [2]",
