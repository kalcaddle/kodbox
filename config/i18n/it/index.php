...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.backup.optionLocation"    => "Si prega di creare un nuovo archivio specifico per il backup dei file",
    "admin.backup.optionTips1"       => "Il backup è diviso in: Backup del database e backup dei file.",
    "admin.backup.optionTips2"       => "Backup del database: genera un file SQL dal contenuto del database ed esegue il backup nella directory del database dell'archivio di destinazione, ovvero l'archivio predefinito del sistema solo per il database.",
    ...
    "admin.restore.recFileDesc2"     => "Nota: la replicazione richiesta dal ripristino dipende dai record dei file del database corrente. Pertanto, se si richiede la reinstallazione del sistema, è necessario prima ripristinare il database.",
