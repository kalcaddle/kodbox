...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "Ad esempio, le informazioni di configurazione del database corrente sono: Utente: test; Password: test123. Accedere al database utilizzando l'account root ed eseguire l'istruzione SQL corrispondente per impostare le autorizzazioni (le autorizzazioni possono essere revocate una volta che il rilevamento è andato a buon fine e il ripristino è andato a buon fine).",
