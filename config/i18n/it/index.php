...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Se la password non è corretta per 5 volte consecutive, l'account verrà bloccato per 1 minuto e non sarà consentito l'accesso. Dopo l'apertura, può prevenire efficacemente il cracking della password;",
...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.emailHostDesc"    => "Server di cassette postali, ad esempio: smtp.163.com, la porta può essere personalizzata (il valore predefinito è 465)",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.backup.db"                => "Banca dati",
    "admin.backup.dbFile"            => "file di database",
 ...
 Supporta pinyin, corrispondenza fuzzy della prima lettera",
    ...
    "explorer.history.diff"          => "Confronto tra versioni storiche",
    ...
    "log-event-edit-item"            => "Modifica aggiornato [1]",
    "log-event-edit-more"            => "Modifica i file [1] aggiornati",
