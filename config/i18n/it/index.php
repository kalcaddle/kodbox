...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.dateFormatDesc"   => "Visualizzazione del formato dell'ora anno-mese-giorno, ora di modifica del file, ecc.",
    ...
    "admin.authFrom.groupRoot"       => "directory principale del dipartimento",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "admin.setting.showFileLink"     => "Visualizzazione del collegamento esterno del file",
    "admin.setting.showFileLinkDesc" => "Dopo la chiusura, le proprietà del file non mostrano più collegamenti esterni",
    "admin.setting.showFileMd5"      => "visualizzazione del file md5",
    "admin.setting.showFileMd5Desc"  => "Dopo la chiusura, le proprietà del file non mostrano più il file md5",
    "admin.setting.shareLinkAllow"   => "Abilita la condivisione di link esterni",
    "admin.setting.shareLinkAllowDesc" => "Dopo la chiusura, non supporterà più la condivisione a catena esterna e il contenuto condiviso non sarà interessato",
    ...
    "admin.setting.shareLinkPasswordAllowEmpty" => "La condivisione a catena esterna consente di svuotare la password",
    "admin.setting.shareLinkPasswordAllowEmptyDesc" => "Dopo la chiusura, è necessario impostare una password per la condivisione del collegamento esterno; il contenuto condiviso non sarà interessato",
    "admin.setting.shareLinkAllowGuest" => "La condivisione di link esterni consente l'accesso ai visitatori non registrati",
    "admin.setting.shareLinkAllowGuestDesc" => "Dopo la chiusura, è necessario effettuare il login quando si accede a collegamenti esterni; il contenuto condiviso non sarà interessato",
    "admin.setting.shareLinkZip"     => "Download cartelle condivise",
    ...
    "explorer.currentHasParent"      => "La cartella di destinazione è una sottocartella della cartella di origine!",    "explorer.pastSuccess"           => "<b>Operazione Incolla completata</b>",
