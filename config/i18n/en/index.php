...
<li> IP range: ip matches within the range; for example: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "After deletion, the department directory will be moved to the system recycle bin,<br> Are you sure you want to continue?",
...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
 ...
 Support pinyin, fuzzy matching of the first letter",
    ...
    "explorer.file.containNow"       => "Currently contains",
    "explorer.file.containAll"       => "Contains the total",
