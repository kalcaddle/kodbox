...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
    ...
    "admin.backup.optionLocation"    => "Please create a new storage specifically for file backup",
    "admin.backup.optionTips1"       => "The backup is divided into two parts: database backup and file backup.",
    "admin.backup.optionTips2"       => "Database backup: Generate an SQL file from the database content and back it up to the database directory of the target storage - the system default storage for only the database.",
    ...
    "admin.restore.recFileDesc2"     => "Note: The replication involved in the restore depends on the file records of the current database. Therefore, if it involves system reinstallation, the database needs to be restored first.",
