...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
    ...
    "admin.storage.ifMove"           => "This storage contains [1] network disk files and will be migrated to the current default storage. Do you want to continue?",
    ...
    "admin.storage.sysFile"          => "Network disk files: files under personal space and departments",
    ...
    "admin.backup.errorDesc"         => "The database or storage is abnormal, causing the backup to be aborted. You can click [End] and then back up manually.",
 ...
 post_max_size, need to restart)",
    ...
    "admin.setting.downloadZipLimit" => "Folder package download limit",
 ...
 Support pinyin, fuzzy matching of the first letter",
    ...
    "explorer.groupTag.menuTtitle"   => "Public label",
