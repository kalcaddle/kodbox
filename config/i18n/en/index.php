...
<li> IP range: ip matches within the range; for example: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "The database switch will import the current data of the system into the new database and set it as the default.<br> Are you sure you want to execute it?",
    ...
    "admin.setting.recDescInfo1"     => "By writing the data in the backup database file to the new database and setting it as the system default, data recovery is realized.",
    "admin.setting.recDescInfo2"     => "The new database configuration parameters will be appended to the system configuration file config/setting_user.php. If the system is abnormal after the recovery is executed, the appended part of the file can be removed without affecting the previous system data.",
    "admin.setting.recDescInfo3"     => "This function only supports processing the backup data generated by the system backup management, and the database backed up by yourself should be processed in other ways.",
...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
    ...
    "admin.share.rptIfBatch"         => "Are you sure you want to do this?",
