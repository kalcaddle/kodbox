...
<li> IP range: ip matches within the range; for example: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "For example, the current database configuration information is: User: test; Password: test123. Use the root account to log in to the database and execute the corresponding SQL statement to set permissions (permissions can be revoked after the test passes and the recovery is successful).",
