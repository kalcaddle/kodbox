...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Access Key ID of Huawei Cloud account, please create or view it in [Console-My Credentials-API Credentials]",
    "admin.storage.obsSecretDesc"    => "Access Key Secret of Huawei Cloud account, the method to obtain is the same as above",
    "admin.storage.bosKeyDesc"       => "Access Key ID of Baidu Cloud account, please create or view it in [Console-Security Authentication-Access Key]",
    "admin.storage.bosSecretDesc"    => "Access Key Secret of Baidu Cloud account, the method to obtain is the same as above",
