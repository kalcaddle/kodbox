...
<li> IP range: ip matches within the range; for example: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "After deletion, the department directory will be moved to the system recycle bin. Are you sure you want to continue?",
    "admin.member.memberRemoveTips"  => "After deletion, the user directory will be moved to the system recycle bin. Are you sure you want to continue?",
