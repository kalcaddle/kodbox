...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
    ...
    "admin.backup.optionLocation"    => "Будь ласка, створіть нове сховище спеціально для резервного копіювання файлів",
    ...
    "admin.backup.optionTips2"       => "Резервне копіювання бази даних: Згенеруйте SQL-файл із вмісту бази даних та створіть його резервну копію в каталог бази даних цільового сховища – системне сховище за замовчуванням лише для бази даних.",
    ...
    "admin.restore.recFileDesc2"     => "Примітка: Реплікація, що використовується під час відновлення, залежить від файлових записів поточної бази даних. Тому, якщо це передбачає перевстановлення системи, спочатку потрібно відновити базу даних.",
