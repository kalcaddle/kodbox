...
<li> Діапазон IP: ip відповідає діапазону; наприклад: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "Наприклад, поточна інформація про конфігурацію бази даних така: User: test; Пароль: test123. Увійдіть до бази даних, використовуючи обліковий запис root, і виконайте відповідний SQL-запит, щоб встановити дозволи (дозволи можна скасувати після успішного виявлення та відновлення).",
