...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
    ...
    "admin.backup.errorDesc"         => "База даних або сховище є ненормальними, що призводить до переривання резервного копіювання. Ви можете натиснути [Завершити], а потім створити резервну копію вручну.",
