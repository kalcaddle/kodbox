...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Ідентифікатор ключа доступу облікового запису Huawei Cloud, створіть або перегляньте його в [Console-My Credentials-API Credentials]",
    "admin.storage.obsSecretDesc"    => "Доступ до секретного ключа облікового запису Huawei Cloud, спосіб отримання той самий, що й вище",
    "admin.storage.bosKeyDesc"       => "Ідентифікатор ключа доступу облікового запису Baidu Cloud, будь ласка, створіть або перегляньте його в [Console-Security Authentication-Access Key]",
    "admin.storage.bosSecretDesc"    => "Доступ до секретного ключа облікового запису Baidu Cloud, спосіб отримання той самий, що й вище",
