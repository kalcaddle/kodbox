...
<li> Діапазон IP: ip відповідає діапазону; наприклад: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Перемикач бази даних імпортує поточні дані системи в нову базу даних і встановить їх за замовчуванням.<br> Ви впевнені, що хочете його виконати?",
    ...
    "admin.setting.recDescInfo1"     => "Запис даних у файл резервної копії бази даних до нової бази даних та встановлення її як системної за замовчуванням забезпечує відновлення даних.",
    "admin.setting.recDescInfo2"     => "Нові параметри конфігурації бази даних будуть додані до файлу конфігурації системи config/setting_user.php.Якщо система не працює нормально після відновлення, додану частину файлу можна видалити, не впливаючи на попередні дані системи.",
    "admin.setting.recDescInfo3"     => "Ця функція підтримує лише обробку даних резервного копіювання, створених системою керування резервними копіями системи, а базу даних, резервну копію якої ви зробите самостійно, слід обробляти іншими способами.",
...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
    ...
    "admin.share.rptIfBatch"         => "Ви впевнені, що хочете це зробити?",
