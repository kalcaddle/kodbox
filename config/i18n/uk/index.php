...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
    ...
    "admin.storage.ifDel"            => "Ви впевнені, що хочете видалити поточне сховище?",
    ...
    "admin.storage.ifRmBakNow"       => "Це сховище містить резервні копії даних. Чи варто нам видалити їх безпосередньо?",
    "admin.storage.moveErr"          => "Неможливо підключити сховище та завершити міграцію даних.",
    "admin.storage.ifRmErrNow"       => "Не вдається підключитися до сховища, і неможливо завершити перенесення даних. Чи варто нам видалити його безпосередньо?",
    ...
    "admin.storage.remove"           => "Видалити сховище",
    ...
    "admin.backup.checkLog"          => "Для отримання детальної інформації дивіться журнал:<br/> дані/темп/журнал/резервна копія/поточна_дата__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "Завдання резервного копіювання файлів виконується раз на хвилину; рекомендується виконувати його у неробочий час.",
 ...
 post_max_size, потрібно перезапустити)",
    ...
    "admin.setting.downloadZipClientDesc" => "Він повинен мати можливість підключатися до зовнішньої мережі, або сайт повинен використовувати HTTPS.",
    ...
    "common.code"                    => "код",
    "common.zoomout"                 => "Зменшити",
    "common.zoomin"                  => "збільшити",
    ...
    "explorer.zipClientLimit1"       => "Якщо файл більший за 4 ГБ, стиснення на стороні фронтенду не може бути завершено. Будь ласка, виберіть завантаження пакетами або скористайтеся клієнтом.",
    "explorer.zipClientLimit2"       => "Файли розміром понад 4 ГБ не можна стиснути на інтерфейсі.",
