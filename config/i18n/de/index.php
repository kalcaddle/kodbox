...
<li> IP-Bereich: IP-Übereinstimmungen innerhalb des Bereichs, z. B. 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Der Datenbankswitch importiert die aktuellen Daten des Systems in die neue Datenbank und setzt diese als Standard.<br> Möchten Sie es wirklich ausführen?",
    ...
    "admin.setting.recDescInfo1"     => "Durch das Schreiben der Daten aus der Backup-Datenbankdatei in die neue Datenbank und deren Einstellung als Systemstandard wird die Datenwiederherstellung realisiert.",
    "admin.setting.recDescInfo2"     => "Die neuen Datenbankkonfigurationsparameter werden an die Systemkonfigurationsdatei config/setting_user.php angehängt.Wenn das System nach der Wiederherstellung abnormal ist, kann der angehängte Teil der Datei entfernt werden, ohne die vorherigen Systemdaten zu beeinträchtigen.",
    "admin.setting.recDescInfo3"     => "Diese Funktion unterstützt nur die Verarbeitung der Backup-Daten, die von der System-Backup-Verwaltung erzeugt wurden, und die von Ihnen gesicherte Datenbank sollte auf andere Weise verarbeitet werden.",
