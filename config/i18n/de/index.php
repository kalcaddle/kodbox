...
<li> Update: Laden Sie nach dem Herunterladen den entsprechenden Plug-In-Namensordner hoch und entpacken Sie ihn.</li>",
    ...
    "admin.storage.ifMove"           => "Dieser Speicher enthält [1] Netzwerkdatenträgerdateien und wird zum aktuellen Standardspeicher migriert. Möchten Sie fortfahren?",
    ...
    "admin.storage.sysFile"          => "Netzwerklaufwerkdateien: Dateien im persönlichen Bereich und in Abteilungen",
    ...
    "admin.storage.obsKeyDesc"       => "Zugriffsschlüssel-ID des Huawei Cloud-Kontos. Bitte erstellen oder sehen Sie sie unter [Konsole – Meine Anmeldeinformationen – API-Anmeldeinformationen]",
    "admin.storage.obsSecretDesc"    => "Greifen Sie auf das Schlüsselgeheimnis des Huawei Cloud-Kontos zu. Die Methode zum Abrufen ist dieselbe wie oben",
    "admin.storage.bosKeyDesc"       => "Zugriffsschlüssel-ID des Baidu Cloud-Kontos, bitte erstellen oder anzeigen unter [Konsole-Sicherheitsauthentifizierung-Zugriffsschlüssel]",
    "admin.storage.bosSecretDesc"    => "Greifen Sie auf das Schlüsselgeheimnis des Baidu Cloud-Kontos zu. Die Methode zum Abrufen ist dieselbe wie oben",
