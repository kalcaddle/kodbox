...
<li> Update: Laden Sie nach dem Herunterladen den entsprechenden Plug-In-Namensordner hoch und entpacken Sie ihn.</li>",
    ...
    "admin.backup.optionLocation"    => "Bitte erstellen Sie einen neuen Speicher speziell für die Dateisicherung",
    "admin.backup.optionTips1"       => "Die Sicherung ist in zwei Teile unterteilt: Datenbanksicherung und Dateisicherung.",
    "admin.backup.optionTips2"       => "Datenbanksicherung: Erstellen Sie eine SQL-Datei aus dem Datenbankinhalt und sichern Sie sie im Datenbankverzeichnis des Zielspeichers – dem Standardspeicher des Systems nur für die Datenbank.",
    ...
    "admin.restore.recFileDesc2"     => "Hinweis: Die bei der Wiederherstellung erforderliche Replikation hängt von den Dateidatensätzen der aktuellen Datenbank ab. Wenn daher eine Neuinstallation des Systems erforderlich ist, muss die Datenbank zuerst wiederhergestellt werden.",
