...
<li> Update: Laden Sie nach dem Herunterladen den entsprechenden Plug-In-Namensordner hoch und entpacken Sie ihn.</li>",
    ...
    "admin.storage.ifDel"            => "Sind Sie sicher, dass Sie den aktuellen Speicher löschen möchten?",
    ...
    "admin.storage.ifRmBakNow"       => "Dieser Speicher enthält Sicherungsdaten. Sollen wir ihn direkt löschen?",
    "admin.storage.moveErr"          => "Der Speicher kann nicht verbunden werden und die Datenmigration kann nicht abgeschlossen werden.",
    "admin.storage.ifRmErrNow"       => "Der Speicher kann nicht verbunden werden, und die Datenmigration kann nicht abgeschlossen werden. Sollen wir ihn direkt löschen?",
    ...
    "admin.storage.remove"           => "Speicher löschen",
    ...
    "admin.backup.checkLog"          => "Für Einzelheiten siehe bitte das Protokoll:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "Die Datensicherung wird einmal pro Minute ausgeführt; es wird empfohlen, sie außerhalb der Arbeitszeiten durchzuführen.",
 ...
 post_max_size, muss neu gestartet werden)",
    ...
    "admin.setting.downloadZipClientDesc" => "Es muss eine Verbindung zum externen Netzwerk herstellen können, oder die Website muss HTTPS verwenden.",
    ...
    "explorer.zipClientLimit1"       => "Ist die Datei größer als 4 GB, kann die Frontend-Komprimierung nicht abgeschlossen werden. Bitte laden Sie die Datei in mehreren Schritten herunter oder verwenden Sie den Client.",
    "explorer.zipClientLimit2"       => "Dateien, die größer als 4 GB sind, können nicht im Frontend komprimiert werden.",
