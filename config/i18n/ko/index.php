...
<li> 업데이트 : 다운로드 후 해당 플러그인 이름 폴더에 업로드하고 압축을 풉니 다.</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Huawei Cloud 계정의 액세스 키 ID를 생성하거나 [콘솔-내 자격 증명-API 자격 증명]에서 확인하세요.",
    "admin.storage.obsSecretDesc"    => "Huawei Cloud 계정의 액세스 키 비밀번호, 획득 방법은 위와 동일합니다.",
    "admin.storage.bosKeyDesc"       => "Baidu Cloud 계정의 Access Key ID는 [콘솔-보안인증-액세스 키]에서 생성하거나 확인하시기 바랍니다.",
    "admin.storage.bosSecretDesc"    => "Baidu Cloud 계정의 Access Key Secret 획득 방법은 위와 동일합니다.",
