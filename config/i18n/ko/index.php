...
<li> 업데이트 : 다운로드 후 해당 플러그인 이름 폴더에 업로드하고 압축을 풉니 다.</li>",
    ...
    "admin.backup.optionLocation"    => "파일 백업을 위해 새로운 저장소를 생성해주세요.",
    "admin.backup.optionTips1"       => "백업은 데이터베이스 백업과 파일 백업의 두 부분으로 나뉩니다.",
    "admin.backup.optionTips2"       => "데이터베이스 백업: 데이터베이스 콘텐츠에서 SQL 파일을 생성하고 대상 저장소의 데이터베이스 디렉토리(데이터베이스 전용 시스템 기본 저장소)에 백업합니다.",
    ...
    "admin.restore.recFileDesc2"     => "참고: 복원에 필요한 복제는 현재 데이터베이스의 파일 레코드에 따라 달라집니다. 따라서 시스템 재설치가 필요한 경우 먼저 데이터베이스를 복원해야 합니다.",
