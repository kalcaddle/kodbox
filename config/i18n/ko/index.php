...
<li> IP 범위 : ip는 범위 내에서 일치합니다 (예 : 192.168.1.1-192.168.200.255).</li>",
    ...
    "admin.setting.recDescInfo32"    => "예를 들어, 현재 데이터베이스 구성 정보는 다음과 같습니다. 사용자: test; 비밀번호: test123. 루트 계정을 사용하여 데이터베이스에 로그인하고 해당 SQL 명령문을 실행하여 권한을 설정합니다(탐지가 통과되고 복구가 성공한 후에는 권한을 취소할 수 있습니다).",
