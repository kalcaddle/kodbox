...
<li> Rango de IP: coincidencias de IP dentro del rango; por ejemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "Por ejemplo, la información de configuración de la base de datos actual es: Usuario: prueba; Contraseña: test123. Inicie sesión en la base de datos utilizando la cuenta raíz y ejecute la declaración SQL correspondiente para establecer los permisos (los permisos se pueden revocar después de que pase la detección y la recuperación sea exitosa).",
