...
<li> Actualización: después de la descarga, cargue y descomprima en la carpeta de nombre del complemento correspondiente;</li>",
    ...
    "admin.backup.optionLocation"    => "Cree un nuevo almacenamiento específicamente para la copia de seguridad de archivos",
    ...
    "admin.backup.optionTips2"       => "Copia de seguridad de la base de datos: genere un archivo SQL a partir del contenido de la base de datos y realice una copia de seguridad en el directorio de la base de datos del almacenamiento de destino (el almacenamiento predeterminado del sistema solo para la base de datos).",
    ...
    "admin.restore.recFileDesc2"     => "Nota: La replicación involucrada en la restauración depende de los registros de archivo de la base de datos actual. Por lo tanto, si implica la reinstalación del sistema, primero debe restaurar la base de datos.",
