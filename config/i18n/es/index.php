...
<li> Rango de IP: coincidencias de IP dentro del rango; por ejemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "El conmutador de base de datos importará los datos actuales del sistema a la nueva base de datos y la establecerá como predeterminada.<br> ¿Estás seguro de que quieres ejecutarlo?",
    ...
    "admin.setting.recDescInfo1"     => "Al escribir los datos en el archivo de la base de datos de respaldo en la nueva base de datos y configurarlo como predeterminado del sistema, se realiza la recuperación de datos.",
    "admin.setting.recDescInfo2"     => "Los nuevos parámetros de configuración de la base de datos se agregarán al archivo de configuración del sistema config / setting_user.php. Si el sistema es anormal después de que se ejecuta la recuperación, la parte adjunta del archivo se puede eliminar sin afectar los datos del sistema anterior.",
    "admin.setting.recDescInfo3"     => "Esta función solo admite el procesamiento de los datos de respaldo generados por la administración de respaldo del sistema, y la base de datos respaldada por usted debe procesarse de otras formas.",
...
<li> Actualización: después de la descarga, cargue y descomprima en la carpeta de nombre del complemento correspondiente;</li>",
    ...
    "admin.share.rptIfBatch"         => "¿Seguro que quieres hacer esto?",
