...
<li> Actualización: después de la descarga, cargue y descomprima en la carpeta de nombre del complemento correspondiente;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Acceda a la ID de clave de la cuenta de Huawei Cloud, créela o véala en [Consola-Mis credenciales-Credenciales API]",
    "admin.storage.obsSecretDesc"    => "Acceda a la clave secreta de la cuenta de Huawei Cloud, el método para obtenerla es el mismo que el anterior",
    "admin.storage.bosKeyDesc"       => "ID de clave de acceso de la cuenta de Baidu Cloud, créela o véala en [Consola-Autenticación de seguridad-Clave de acceso]",
    "admin.storage.bosSecretDesc"    => "Acceda a la clave secreta de la cuenta de Baidu Cloud, el método para obtenerla es el mismo que el anterior",
