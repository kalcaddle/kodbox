...
<li> अपडेट: डाउनलोड करने के बाद, अपलोड करें और संबंधित प्लग-इन नाम फ़ोल्डर में अनज़िप करें;</li>",
    ...
    "admin.storage.ifDel"            => "क्या आप वाकई मौजूदा स्टोरेज को डिलीट करना चाहते हैं?",
    ...
    "admin.storage.ifRmBakNow"       => "इस स्टोरेज में बैकअप डेटा है। क्या हमें इसे सीधे डिलीट कर देना चाहिए?",
    "admin.storage.moveErr"          => "भंडारण कनेक्ट नहीं किया जा सकता और डेटा माइग्रेशन पूरा नहीं किया जा सकता.",
    "admin.storage.ifRmErrNow"       => "स्टोरेज कनेक्ट नहीं हो पा रहा है, और डेटा माइग्रेशन पूरा नहीं हो पा रहा है। क्या हमें इसे सीधे डिलीट कर देना चाहिए?",
    ...
    "admin.storage.remove"           => "संग्रहण हटाएं",
    ...
    "admin.backup.checkLog"          => "अधिक जानकारी के लिए, कृपया लॉग देखें:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "फाइल बैकअप का कार्य प्रति मिनट एक बार चलता है; इसे कार्य समय के अलावा अन्य समय में करने की सलाह दी जाती है।",
 ...
 post_max_size, पुनरारंभ करने की आवश्यकता है)",
    ...
    "admin.setting.downloadZipClientDesc" => "इसे बाहरी नेटवर्क से कनेक्ट करने में सक्षम होना चाहिए, या साइट HTTPS होनी चाहिए।",
    ...
    "common.code"                    => "कोड",
    "common.zoomout"                 => "सिकुड़ना",
    "common.zoomin"                  => "बड़े आकार में",
    "common.share"                   => "शेयर",
    "common.search"                  => "खोजें",
    "common.query"                   => "पूछताछ",
    "common.delete"                  => "हटाएं",
    ...
    "explorer.zipClientLimit1"       => "यदि फ़ाइल का आकार 4GB से अधिक है, तो फ्रंट-एंड कम्प्रेशन पूरा नहीं हो पाएगा। कृपया इसे बैच में डाउनलोड करने का विकल्प चुनें या क्लाइंट का उपयोग करें।",
    "explorer.zipClientLimit2"       => "4 जीबी से बड़ी फाइलों को फ्रंट एंड पर कंप्रेस नहीं किया जा सकता है।",
