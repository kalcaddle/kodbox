...
<li> अपडेट: डाउनलोड करने के बाद, अपलोड करें और संबंधित प्लग-इन नाम फ़ोल्डर में अनज़िप करें;</li>",
    ...
    "admin.storage.ifMove"           => "इस संग्रहण में [1] नेटवर्क डिस्क फ़ाइलें हैं और इसे वर्तमान डिफ़ॉल्ट संग्रहण में माइग्रेट कर दिया जाएगा। क्या आप जारी रखना चाहते हैं?",
    ...
    "admin.storage.sysFile"          => "नेटवर्क डिस्क फ़ाइलें: व्यक्तिगत स्थान और विभागों के अंतर्गत फ़ाइलें",
    ...
    "admin.storage.obsKeyDesc"       => "हुआवेई क्लाउड खाते की एक्सेस कुंजी आईडी, कृपया इसे बनाएं या [कंसोल-माय क्रेडेंशियल्स-एपीआई क्रेडेंशियल्स] में देखें",
    "admin.storage.obsSecretDesc"    => "हुआवेई क्लाउड खाते की एक्सेस कुंजी रहस्य, प्राप्त करने की विधि ऊपर के समान है",
    "admin.storage.bosKeyDesc"       => "Baidu क्लाउड खाते की एक्सेस कुंजी आईडी, कृपया इसे बनाएं या [कंसोल-सुरक्षा प्रमाणीकरण-एक्सेस कुंजी] में देखें",
    "admin.storage.bosSecretDesc"    => "Baidu क्लाउड खाते का एक्सेस कुंजी रहस्य, प्राप्त करने की विधि उपरोक्त के समान है",
