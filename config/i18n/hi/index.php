...
<li> अपडेट: डाउनलोड करने के बाद, अपलोड करें और संबंधित प्लग-इन नाम फ़ोल्डर में अनज़िप करें;</li>",
    ...
    "admin.backup.optionLocation"    => "कृपया फ़ाइल बैकअप के लिए विशेष रूप से एक नया संग्रहण बनाएँ",
    "admin.backup.optionTips1"       => "बैकअप को दो भागों में बांटा गया है: डेटाबेस बैकअप और फाइल बैकअप।",
    "admin.backup.optionTips2"       => "डेटाबेस बैकअप: डेटाबेस सामग्री से एक SQL फ़ाइल बनाएं और उसे लक्ष्य संग्रहण की डेटाबेस निर्देशिका में बैकअप करें - जो केवल डेटाबेस के लिए सिस्टम डिफ़ॉल्ट संग्रहण है।",
    ...
    "admin.restore.recFileDesc2"     => "नोट: पुनर्स्थापना में शामिल प्रतिकृति वर्तमान डेटाबेस के फ़ाइल रिकॉर्ड पर निर्भर करती है। इसलिए, यदि इसमें सिस्टम पुनर्स्थापना शामिल है, तो पहले डेटाबेस को पुनर्स्थापित करना आवश्यक है।",
