...
<li> आईपी रेंज: आईपी सीमा के भीतर मेल खाती है; उदाहरण के लिए: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "डेटाबेस स्विच सिस्टम के वर्तमान डेटा को नए डेटाबेस में आयात करेगा और इसे डिफ़ॉल्ट के रूप में सेट करेगा।<br> क्या आप वाकई इसे निष्पादित करना चाहते हैं?",
    ...
    "admin.setting.recDescInfo1"     => "बैकअप डेटाबेस फ़ाइल में डेटा को नए डेटाबेस में लिखकर और इसे सिस्टम डिफ़ॉल्ट के रूप में सेट करके, डेटा रिकवरी का एहसास होता है।",
    "admin.setting.recDescInfo2"     => "नया डेटाबेस कॉन्फ़िगरेशन पैरामीटर सिस्टम कॉन्फ़िगरेशन फ़ाइल config/setting_user.php में जोड़ा जाएगा। यदि पुनर्प्राप्ति निष्पादित होने के बाद सिस्टम असामान्य है, तो फ़ाइल के संलग्न भाग को पिछले सिस्टम डेटा को प्रभावित किए बिना हटाया जा सकता है।",
    "admin.setting.recDescInfo3"     => "यह फ़ंक्शन केवल सिस्टम बैकअप प्रबंधन द्वारा उत्पन्न बैकअप डेटा को संसाधित करने का समर्थन करता है, और आपके द्वारा बैकअप किए गए डेटाबेस को अन्य तरीकों से संसाधित किया जाना चाहिए।",
