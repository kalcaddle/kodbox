...
<li> Plage IP: l'adresse IP correspond à la plage; par exemple: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Le commutateur de base de données importera les données actuelles du système dans la nouvelle base de données et les définira comme valeur par défaut.<br> Êtes-vous sûr de vouloir l'exécuter ?",
    ...
    "admin.setting.recDescInfo1"     => "En écrivant les données du fichier de base de données de sauvegarde dans la nouvelle base de données et en la définissant comme valeur par défaut du système, la récupération des données est réalisée.",
    "admin.setting.recDescInfo2"     => "Les nouveaux paramètres de configuration de la base de données seront ajoutés au fichier de configuration du système config/setting_user.php. Si le système est anormal après l'exécution de la récupération, la partie ajoutée du fichier peut être supprimée sans affecter les données système précédentes.",
    "admin.setting.recDescInfo3"     => "Cette fonction prend uniquement en charge le traitement des données de sauvegarde générées par la gestion des sauvegardes du système, et la base de données sauvegardée par vous-même doit être traitée d'une autre manière.",
...
<li> Mise à jour: après le téléchargement, téléchargez et décompressez dans le dossier de nom de plug-in correspondant;</li>",
    ...
    "admin.share.rptIfBatch"         => "Es-tu sûr de vouloir faire ça?",
