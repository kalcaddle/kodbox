...
<li> Mise à jour: après le téléchargement, téléchargez et décompressez dans le dossier de nom de plug-in correspondant;</li>",
    ...
    "admin.backup.optionLocation"    => "Veuillez créer un nouveau stockage spécifiquement pour la sauvegarde des fichiers",
    ...
    "admin.backup.optionTips2"       => "Sauvegarde de la base de données : générez un fichier SQL à partir du contenu de la base de données et sauvegardez-le dans le répertoire de base de données du stockage cible - le stockage par défaut du système pour la base de données uniquement.",
    ...
    "admin.restore.recFileDesc2"     => "Remarque : La réplication impliquée dans la restauration dépend des enregistrements de fichiers de la base de données actuelle. Par conséquent, si elle implique une réinstallation du système, vous devez d'abord restaurer la base de données.",
