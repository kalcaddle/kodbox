...
<li> Mise à jour: après le téléchargement, téléchargez et décompressez dans le dossier de nom de plug-in correspondant;</li>",
    ...
    "admin.storage.ifMove"           => "Ce stockage contient [1] fichiers de disque réseau et sera migré vers le stockage par défaut actuel. Voulez-vous continuer ?",
    ...
    "admin.storage.sysFile"          => "Fichiers disque réseau : fichiers sous espace personnel et départements",
    ...
    "admin.backup.errorDesc"         => "La base de données ou le stockage est anormal, provoquant l'abandon de la sauvegarde. Vous pouvez cliquer sur [Fin] puis sauvegarder manuellement.",
 ...
 post_max_size, besoin de redémarrer)",
    ...
    "admin.setting.downloadZipLimit" => "Limite de téléchargement de package de dossier",
