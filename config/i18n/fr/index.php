...
<li> Mise à jour: après le téléchargement, téléchargez et décompressez dans le dossier de nom de plug-in correspondant;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Accédez à l'ID de clé du compte Huawei Cloud, veuillez le créer ou l'afficher dans [Console-Mes informations d'identification-Crédits API]",
    "admin.storage.obsSecretDesc"    => "Accédez à la clé secrète du compte Huawei Cloud, la méthode pour l'obtenir est la même que ci-dessus",
    "admin.storage.bosKeyDesc"       => "ID de clé d'accès du compte Baidu Cloud, veuillez le créer ou l'afficher dans [Console-Security Authentication-Access Key]",
    "admin.storage.bosSecretDesc"    => "Accédez à la clé secrète du compte Baidu Cloud, la méthode pour l'obtenir est la même que ci-dessus",
