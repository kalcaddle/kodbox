...
<li> Zakres adresów IP: ip pasuje do zakresu; na przykład: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Przełącznik bazy danych zaimportuje bieżące dane systemu do nowej bazy danych i ustawi ją jako domyślną.<br> Czy na pewno chcesz to wykonać?",
    ...
    "admin.setting.recDescInfo1"     => "Poprzez zapisanie danych w pliku kopii zapasowej bazy danych do nowej bazy danych i ustawienie jej jako domyślnej systemowej, odzyskiwanie danych jest realizowane.",
    "admin.setting.recDescInfo2"     => "Nowe parametry konfiguracyjne bazy danych zostaną dołączone do pliku konfiguracyjnego systemu config/setting_user.php.Jeśli system działa nieprawidłowo po wykonaniu odzyskiwania, dołączona część pliku może zostać usunięta bez wpływu na poprzednie dane systemowe.",
    "admin.setting.recDescInfo3"     => "Ta funkcja obsługuje tylko przetwarzanie danych kopii zapasowych wygenerowanych przez system zarządzania kopiami zapasowymi, a baza danych, której kopię zapasową utworzyłeś, powinna być przetwarzana w inny sposób.",
...
<li> Aktualizacja: po pobraniu prześlij i rozpakuj do odpowiedniego folderu z nazwą wtyczki;</li>",
    ...
    "admin.share.rptIfBatch"         => "Czy na pewno chcesz to zrobić?",
