...
<li> Zakres adresów IP: ip pasuje do zakresu; na przykład: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "Na przykład bieżące informacje o konfiguracji bazy danych wyglądają następująco: Użytkownik: test; Hasło: test123. Zaloguj się do bazy danych przy użyciu konta root i wykonaj odpowiednie polecenie SQL, aby ustawić uprawnienia (uprawnienia mogą zostać cofnięte po pomyślnym zakończeniu wykrywania i odzyskaniu danych).",
