...
<li> Aktualizacja: po pobraniu prześlij i rozpakuj do odpowiedniego folderu z nazwą wtyczki;</li>",
    ...
    "admin.backup.optionLocation"    => "Proszę utworzyć nowe miejsce przechowywania przeznaczone specjalnie do tworzenia kopii zapasowych plików",
    ...
    "admin.backup.optionTips2"       => "Kopia zapasowa bazy danych: Generuj plik SQL z zawartości bazy danych i utwórz jego kopię zapasową w katalogu bazy danych w docelowym magazynie — domyślnym magazynie systemu przeznaczonym wyłącznie dla bazy danych.",
    ...
    "admin.restore.recFileDesc2"     => "Uwaga: Replikacja związana z przywracaniem zależy od rekordów plików w bieżącej bazie danych. Dlatego, jeśli wiąże się to z ponowną instalacją systemu, najpierw należy przywrócić bazę danych.",
