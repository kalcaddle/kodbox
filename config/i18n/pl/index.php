...
<li> Aktualizacja: po pobraniu prześlij i rozpakuj do odpowiedniego folderu z nazwą wtyczki;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Identyfikator klucza dostępu do konta Huawei Cloud, utwórz go lub wyświetl w [Konsola-Moje dane uwierzytelniające-Poświadczenia API]",
    "admin.storage.obsSecretDesc"    => "Uzyskaj dostęp do tajnego klucza konta Huawei Cloud, metoda uzyskania jest taka sama jak powyżej",
    "admin.storage.bosKeyDesc"       => "Identyfikator klucza dostępu konta Baidu Cloud, utwórz go lub wyświetl w [Konsola-Uwierzytelnianie bezpieczeństwa-Klucz dostępu]",
    "admin.storage.bosSecretDesc"    => "Uzyskaj dostęp do tajnego klucza konta Baidu Cloud, metoda uzyskania jest taka sama jak powyżej",
