...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Huawei CloudアカウントのアクセスキーID。[コンソール-私の認証情報-API認証情報]で作成または表示してください。",
    "admin.storage.obsSecretDesc"    => "Huawei Cloudアカウントのアクセスキーシークレット、取得方法は上記と同じです",
    "admin.storage.bosKeyDesc"       => "Baidu Cloud アカウントのアクセス キー ID。[コンソール - セキュリティ認証 - アクセス キー] で作成または表示してください。",
    "admin.storage.bosSecretDesc"    => "Baidu Cloud アカウントのアクセスキーシークレット、取得方法は上記と同じです",
