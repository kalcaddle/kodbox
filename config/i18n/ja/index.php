...
return array(
    ...
    "admin.menu.groupMember"         => "グループおよびメンバー管理",
    "admin.menu.member"              => "グループとユーザー",
    ...
    "admin.index.groupSpace"         => "グループスペース",
    ...
    "admin.index.spaceGroup"         => "グループの使用",
...
<li> IP範囲：IPは範囲内で一致します。例：192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"><b>ユーザーログイン制限の制御手順（IPおよびデバイスの制限）：</b></h5><li>ルールの優先順位に従って順番に検出します。ルールで指定されたユーザーには、現在ログインしているユーザーが含まれます。その結果、ルールが決定されます。</li><li>ユーザーグループとグループユーザーを背面に配置し、ユーザー設定を前面に指定することをお勧めします（ドラッグアンドドロップで順序を調整します）</li>",
    ...
    "admin.setting.registCheckDesc"  => "登録ユーザーが正常に利用するためには、管理者が［ユーザーとグループ］で確認・有効化する必要があります。",
    ...
    "admin.setting.registNeedRewiew" => "設定後、登録ユーザーが正常に利用するためには、管理者が［ユーザーとグループ］で確認・有効化する必要があります。",
    ...
    "admin.setting.groupListChildDesc" => "グループフォルダがサブグループを表示するかどうかにかかわらず、権限は上位に継承されます",
    "admin.setting.groupRootListChild" => "エンタープライズWebディスクはサブセクターをリストします",
    "admin.setting.groupRootListChildDesc" => "企業ネットワークのディスクフォルダーにサブグループが表示され、権限が上位に継承されるかどうか",
    "admin.setting.shareToMeAllowTree" => "私と協力する-組織構造ごとに表示",
    "admin.setting.shareToMeAllowTreeTips" => "開業後、私とのコラボレーションのコンテンツサポートは、グループの組織構造に応じて分類されており、組織構造がより複雑な状況に適しています。",
    "admin.setting.groupTagAllow"    => "グループのパブリックレーベル",
    "admin.setting.groupTagAllowTips" => "有効にすると、グループ内のファイルのパブリックラベルを設定すると、すべてのグループメンバーが表示されます。グループ管理者は、ラベルの内容を管理できます。",
    "admin.setting.groupSpaceLimit"  => "グループネットワークのディスクレベル制限",
    "admin.setting.groupSpaceLimitTips" => "グループを超えた階層にはグループネットワークディスクは表示されません",
    "admin.setting.groupSpaceLimitLevel" => "グループネットワークディスクレベル",
    "admin.setting.groupSpaceLimitLevelTips" => "レベルを指定します。デフォルトは 5 レベル以上です。グループネットワーク ディスクは表示されません。最小値は 2 です。",
    ...
    "admin.group.parent"             => "上位グループ",
    "admin.group.authShow"           => "グループのメンバーに見える組織構造の範囲",
    "admin.group.authShowAll"        => "すべてのグループ",
    "admin.group.authShowHide"       => "このグループとサブグループのみ",
    "admin.group.authShowSelect"     => "指定グループ",
    "admin.group.authShowAllTips"    => "このグループのメンバーが協力して共有すると、他のすべてのグループ（およびユーザー）を選択できます",
    "admin.group.authShowHideTips"   => "このグループのメンバーが共同作業して共有する場合、現在のグループとサブグループ（およびユーザー）のみがサポートされます",
    "admin.group.authShowSelectTips" => "グループのメンバーが共同で共有する場合、現在のグループとサブグループを含む、指定されたグループとサブグループ（およびユーザー）を選択できます。",
    "admin.group.addSub"             => "サブセクターを追加",
    "admin.group.remove"             => "グループを削除",
    "admin.group.removeBatch"        => "グループを一括削除",
    "admin.group.removeBatchDesc"    => "複数のグループを選択して一括削除することもできますので、慎重に操作してください。",
    "admin.group.removeSub"          => "サブグループの削除",
    "admin.group.removeSubDesc"      => "有効にすると、すべてのサブグループが同時に削除されます。それ以外の場合は、選択したグループのみが削除され、サブグループは自動的に親グループに所属します。",
    "admin.group.switch"             => "移行",
    "admin.group.swtichDesc"         => "選択したグループ (およびそのサブグループ) のユーザーとファイルをターゲットグループに移行します。",
    "admin.group.switchSameError"    => "対象グループを選択したグループと同じにすることはできません",
    "admin.group.switching"          => "移行中、お待ちください...",
    "admin.group.groupSwitching"     => "選択したグループが移行中です",
    "admin.group.parentNullError"    => "上層部を空にすることはできません",
    "admin.group.selected"           => "選択したグループ",
    "admin.group.setSizeBatch"       => "スペースサイズをバッチで設定する",
    "admin.group.multiSelect"        => "複数のグループをバッチ設定用に選択できます",
    "admin.group.ifDisAll"           => "すべてのサブグループが無効になります。実行してもよろしいですか？",
    "admin.group.nameErr"            => "グループ名には含めることはできません",
    "admin.member.manage"            => "ユーザーとグループ",
    "admin.member.add"               => "新しいユーザー",
    "admin.member.role"              => "権限",
    "admin.member.group"             => "グループ",
    "admin.member.groupAdd"          => "グループを追加",
    ...
    "admin.member.groupRemove"       => "グループから削除",
    "admin.member.groupInsert"       => "グループに追加",
    "admin.member.groupSwitch"       => "グループに移行する",
    "admin.member.groupTarget"       => "対象グループ",
    "admin.member.groupReset"        => "グループのリセット",
    "admin.member.groupSwtichDesc"   => "選択したユーザーを現在のグループからターゲットグループに移行します",
    "admin.group.setGroupOwner"      => "グループ管理者の設定",
    "admin.group.ownerAllowEditUser" => "ユーザーの編集を許可する",
    "admin.group.setGroupOwnerTips"  => "<b>グループ管理者の権限:</b><br/><br/><li>ユーザーはこのグループの所有者権限を持っています</li><li>ユーザーの編集を許可すると、ユーザーの権限はデフォルトでグループ管理者に設定され、バックグラウンドでグループ配下のユーザーを編集したり、グループおよびサブグループを編集したりできるようになります。</li><li>解除方法：該当ユーザーを編集し、権限を一般ユーザーに変更し、ユーザーの所属グループの権限を変更します。</li>",
    ...
    "admin.member.importGroupErr"    => "その部署は空っぽだ。",
    ...
    "admin.member.importGroupPathErr" => "指定された部門パスは存在しません。",
    "admin.member.importAuthErr"     => "指定された権限は存在しません。",
    "admin.member.importGroup1"      => "エンタープライズクラウドストレージ／研究開発部門／研究開発グループ2",
    "admin.member.importGroup2"      => "エンタープライズクラウドストレージ／運用保守部門",
    "admin.member.importCopyGroupTips" => "部門データを読み込み中です。しばらくしてからもう一度お試しください。",
    ...
    "admin.member.importContinue"    => "輸入を続ける",
    ...
    "admin.member.importUserGroup"   => "ユーザー部門",
    "admin.member.importGroupSet"    => "統合設定",
    "admin.member.importGroupImport" => "インポート設定",
    "admin.member.importGroupDesc"   => "統合設定: インターフェイスで設定を選択して、インポートされたすべてのアカウントの統合された部門と権限を指定します。[0] インポート設定: テンプレートに部門と権限のフィールドを追加します。部門フィールドには部門の完全なパス (例:<code>企业网盘/研发部/研发二组</code>) が入力され、複数のフィールドは<code>;</code>で区切られます。権限フィールドには権限名が入力され、複数のフィールドも<code>;</code>で区切られます。2 つのフィールドの内容は 1 対 1 で対応します。",
    ...
    "admin.member.importCopyGroupDesc" => "選択した部門の完全なパスをコピーします",
    ...
    "admin.member.importDownData"    => "輸出電流",
    "admin.member.importDownDataDesc" => "現在のアカウントすべてをテンプレート形式でエクスポートします",
    "admin.member.groupRemoveTips"   => "削除後、グループファイルはシステムのごみ箱に移動されます。続行してもよろしいですか?",
    "admin.member.memberRemoveTips"  => "削除後、ユーザー ファイルはシステムのごみ箱に移動されます。続行してもよろしいですか?",
    "admin.member.freeGroupRemoveTips" => "削除後、グループファイルも削除されます。続行してもよろしいですか?",
    ...
    "admin.member.allAdd"            => "ユーザーまたはグループを追加",
    ...
    "admin.member.searchGroup"       => "検索グループ（ピンインとあいまい一致のサポート）",
    "admin.member.searchAll"         => "ユーザーまたはグループの検索（ピンインとあいまい一致のサポート）",
    "admin.member.editNoAuth"        => "申し訳ありませんが、この権限はありません。 <br/>システム管理者のみがシステム管理者を追加および変更できます",
    "admin.member.disabledUsers"     => "アカウントが無効になっています",
    "admin.member.disabledTips"      => "グループを切り替えてチェックを外します",
    "admin.member.userGroup"         => "ユーザーグループ",
    "admin.member.userRole"          => "ユーザー権限",
    "admin.member.userSelected"      => "選択したユーザー",
    "admin.member.authCopy"          => "グループの権限をコピーする",
    "admin.member.authPaste"         => "グループ権限ペースト",
    "admin.member.ifAuthPaste"       => "コピーしたグループの権限を現在のユーザーに設定してもよろしいですか？",
    ...
    "admin.auth.targetError"         => "権限オブジェクトの種類が間違っています。ユーザーまたはグループである必要があります",
    "admin.auth.errorAuthToGroup"    => "非ルートグループ、グループへの委任はサポートしていません",
    "admin.auth.errorAuthToUsers"    => "非ルートセクター、セクター外のメンバーへの委任はサポートしていません",
    "admin.auth.displayDesc"         => "グループのユーザー権限を設定するときに表示するかどうか",
...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
    ...
    "admin.install.defGroupError"    => "システムグループの追加に失敗しました",
    ...
    "admin.install.groupFile"        => "グループ文書",
    ...
    "admin.log.addUserTo"            => "ユーザーをグループに追加する",
    "admin.log.removeUserFrom"       => "ユーザーがグループから削除されました",
    "admin.log.switchUserGroup"      => "ユーザー移行グループ",
    ...
    "admin.share.targetTitle"        => "コラボレーションのためのグループまたはユーザー",
 ...
 post_max_size、再起動が必要）",
    ...
    "explorer.search.optionGroup"    => "サブグループを検索",
    "explorer.search.optionGroupDesc" => "自分が所有者の場合、グループのルート ディレクトリを検索するときに、サブグループのコンテンツも同時に検索します。",
    "explorer.search.optionGroupTips" => "およびサブグループ",
    ...
    "explorer.auth.toOuter"          => "外部認証（他のグループまたはユーザー）",
    ...
    "explorer.toolbar.myGroup"       => "マイグループ",
    "explorer.toolbar.myGroupAllow"  => "私の権限のあるグループ",
    ...
    "explorer.toolbar.shareTo"       => "共有ファイル",
...
デフォルトでは、すべてのメンバーが表示されます",
    "explorer.pathDesc.myGroup"      => "ここであなたのグループのドキュメントを管理し、
グループのドキュメントは、このグループのメンバーのみが表示および操作でき、他のグループのメンバーには表示されません。",
    "explorer.pathDesc.group"        => "グループのメンバーにのみ表示されるグループのネットワークディスクで、
運用権限は、グループ管理者が割り当て、設定します。",
    ...
    "explorer.pathDesc.shareToMeGroup" => "私がコラボレーションしているコンテンツは、フォルダーが配置されているグループによって分類されています",
    "explorer.pathDesc.shareToMeGroupGroup" => "グループのネットワークディスクからのコラボレーション",
...
拼音、最初の文字のあいまい一致をサポート",
    ...
    "explorer.pathGroup.shareGroup"  => "グループスペース",
    "explorer.pathGroup.shareGroupDesc" => "下位グループにコンテンツがある場合のアクセス",
    "explorer.pathGroup.shareUser"   => "グループメンバーの個人的なスペース共有",
    "explorer.pathGroup.shareUserDesc" => "出典：ユーザーの個人用スペースの共有、ユーザーが開始した外部グループのドキュメント共有。",
    "explorer.pathGroup.shareContent" => "グループの宇宙コラボレーションと共有",
    "explorer.pathGroup.group"       => "サブグループ",
    "explorer.pathGroup.groupContent" => "グループ文書",
    ...
    "explorer.search.optionTag"      => "ユーザー/グループラベル",
    ...
    "explorer.recycle.configOpenInfo" => "<li>個人文書またはグループ文書は、ごみ箱を完全に削除または空にした後、システムのごみ箱に入ります。</li><li>削除されたコンテンツは、ファイルが配置されているユーザーまたはグループに応じてユーザーまたはグループフォルダーに分類され、管理者はこれらのファイルを復元することを選択できます。</li><li>自動完全削除の前のファイルは、定期的に自動的に空になります。</li><li>注：ここで削除されたファイルは復元できません。</li>",
    ...
    "explorer.recycle.moveSelectTarget" => "ユーザーまたはグループを選択します",
    "explorer.recycle.moveDesc"      => "<li>指定されたユーザーまたはグループに引き渡します。オブジェクトのルートディレクトリに移行されます</li><li>引き渡し後、ドキュメントの説明、交換、ディスカッション、バージョン履歴、その他の情報は引き続き保持されます。共有されているコラボレーションと権限の情報は削除されます。</li>",
    ...
    "explorer.share.selectTarget"    => "コラボレーションするグループまたはユーザーを選択します",
    "explorer.share.afterShareDesc"  => "相手または所属するグループと共有すると、ユーザーは[共有]でそれを見ることができます。",
    ...
    "explorer.share.specifyAuthDesc" => "指定ユーザー権限>指定ユーザーのグループ権限>その他の個人権限",
    "explorer.share.selfAuthDesc"    => "自分の権限を変更することはできません。他のマネージャーが設定できます",
    "explorer.share.authTypeDesc"    => "既定で親フォルダーからアクセス権限を継承する",
    "explorer.share.rootPathAuthDesc" => "ルートグループのサポートユーザーおよびグループの選択",
    "explorer.share.subPathAuthDesc" => "サブグループ、グループのメンバーのみを選択",
    ...
    "explorer.shareOut.targetUserDesc3" => "サポートグループIDの指定（例）",
    ...
    "explorer.shareOut.siteSafeDesc1" => "外部コラボレーションに使用する場合、信頼できるサイトの組織構造を取得し、ユーザーとグループを素早く選択できます。",
    ...
    "explorer.auth.tabUser"          => "グループメンバー",
    "explorer.auth.tabChildren"      => "サブフォルダーのアクセス権限",
    "explorer.auth.tabParentTips"    => "このフォルダに対する権限を持つユーザーまたはグループ（上位レベルの権限すべてから継承）",
    "explorer.auth.tabUserTips"      => "グループメンバーの初期権限",
    ...
    "explorer.groupTag.menuTtitle"   => "グループのパブリックレーベル",
    "explorer.groupTag.titleDesc"    => "グループ内のパブリックラベル",
    "explorer.groupTag.empty"        => "グループ管理者がパブリックラベルを設定すると、自動的に有効になります。ラベルの内容がない場合、パブリックラベルは自動的にオフになります。",
    "explorer.tag.pathDesc"          => "個人ラベルでフィルタリング",
    "explorer.groupTag.pathDesc"     => "グループのパブリックラベルでフィルタリング",
    ...
    "explorer.groupTag.addDesc"      => "タグを追加すると、グループタグが自動的に有効になり、タグの最大数は1000になります",
    ...
    "explorer.panel.info.groupAt"    => "グループの場所",
    ...
    "explorer.safe.adminOpen"        => "パーソナル スペースの機密フォルダを有効にする",
    ...
    "explorer.secret.setUserDesc"    => "機密レベルを設定できるユーザーを指定します（該当グループのオーナーにすることを推奨します）",
    ...
    "explorer.secret.tips1"          => "グループネットワークディスク内のコンテンツのみ、上記の指定ユーザー（フォルダ所有者であることが推奨されます）が設定できます。",
    ...
    "explorer.secret.tips4"          => "機密レベルの権限: \"グループおよびメンバー管理 - ドキュメント著作権管理\"で追加でき、非表示に設定できます",
    "user.----"                      => "----",
