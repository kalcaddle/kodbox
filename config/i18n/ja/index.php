...
<li> IP範囲：IPは範囲内で一致します。例：192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "たとえば、現在のデータベース構成情報は次のとおりです: ユーザー: test;パスワード: test123。ルート アカウントを使用してデータベースにログインし、対応する SQL ステートメントを実行して権限を設定します (検出が成功し、回復が成功した後に権限を取り消すことができます)。",
