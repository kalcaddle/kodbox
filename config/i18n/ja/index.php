...
<li> IP範囲：IPは範囲内で一致します。例：192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "データベーススイッチは、システムの現在のデータを新しいデータベースにインポートし、それをデフォルトとして設定します。<br>実行してもよろしいですか？",
    ...
    "admin.setting.recDescInfo1"     => "バックアップデータベースファイルのデータを新しいデータベースに書き込み、それをシステムデフォルトとして設定することにより、データリカバリが実現されます。",
    "admin.setting.recDescInfo2"     => "新しいデータベース構成パラメーターは、システム構成ファイルconfig / settings_user.phpに追加されます。リカバリーの実行後にシステムが異常である場合、ファイルの追加された部分は、以前のシステムデータに影響を与えることなく削除できます。",
    "admin.setting.recDescInfo3"     => "この機能は、システムのバックアップ管理によって生成されたバックアップデータの処理のみをサポートします。自分でバックアップしたデータベースは、他の方法で処理する必要があります。",
...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
    ...
    "admin.share.rptIfBatch"         => "これを実行してもよろしいですか？",
