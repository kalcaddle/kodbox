...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
    ...
    "admin.backup.optionLocation"    => "ファイルバックアップ専用の新しいストレージを作成してください",
    "admin.backup.optionTips1"       => "バックアップは、データベースバックアップとファイルバックアップの2つの部分に分かれています。",
    "admin.backup.optionTips2"       => "データベースのバックアップ: データベースの内容から SQL ファイルを生成し、ターゲット ストレージ (データベース専用のシステム デフォルト ストレージ) のデータベース ディレクトリにバックアップします。",
    ...
    "admin.restore.recFileDesc2"     => "注: 復元に含まれるレプリケーションは、現在のデータベースのファイルレコードに依存します。そのため、システムの再インストールが必要な場合は、まずデータベースを復元する必要があります。",
