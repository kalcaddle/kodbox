...
<li> تحديث: بعد التنزيل والتحميل وفك الضغط إلى مجلد اسم المكون الإضافي المقابل ؛</li>",
    ...
    "admin.backup.optionLocation"    => "يرجى إنشاء وحدة تخزين جديدة خصيصًا للنسخ الاحتياطي للملفات",
    "admin.backup.optionTips1"       => "يتم تقسيم النسخة الاحتياطية إلى جزأين: نسخة احتياطية لقاعدة البيانات ونسخ احتياطي للملف.",
    "admin.backup.optionTips2"       => "نسخ احتياطي لقاعدة البيانات: إنشاء ملف SQL من محتوى قاعدة البيانات والنسخ الاحتياطي له إلى دليل قاعدة البيانات للتخزين المستهدف - التخزين الافتراضي للنظام لقاعدة البيانات فقط.",
    ...
    "admin.restore.recFileDesc2"     => "ملاحظة: تعتمد عملية التكرار في عملية الاستعادة على سجلات ملفات قاعدة البيانات الحالية. لذلك، إذا تطلب الأمر إعادة تثبيت النظام، فيجب استعادة قاعدة البيانات أولًا.",
