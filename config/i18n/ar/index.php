...
<li> تحديث: بعد التنزيل والتحميل وفك الضغط إلى مجلد اسم المكون الإضافي المقابل ؛</li>",
    ...
    "admin.storage.ifMove"           => "تحتوي هذه التخزين على [1] ملفات قرص شبكة الاتصال وسيتم ترحيلها إلى وحدة التخزين الافتراضية الحالية. هل تريد المتابعة؟",
    ...
    "admin.storage.sysFile"          => "ملفات قرص الشبكة: الملفات الموجودة ضمن المساحة الشخصية والأقسام",
    ...
    "admin.backup.errorDesc"         => "قاعدة البيانات أو وحدة التخزين غير طبيعية ، مما تسبب في إحباط النسخ الاحتياطي. يمكنك النقر فوق [End] ثم النسخ الاحتياطي يدويًا.",
 ...
 post_max_size ، تحتاج إلى إعادة التشغيل)",
    ...
    "admin.setting.downloadZipLimit" => "حد تنزيل حزمة المجلد",
