...
<li> نطاق IP: تطابق IP ضمن النطاق ؛ على سبيل المثال: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "على سبيل المثال، معلومات تكوين قاعدة البيانات الحالية هي: المستخدم: اختبار؛ كلمة المرور: test123. قم بتسجيل الدخول إلى قاعدة البيانات باستخدام حساب الجذر وقم بتنفيذ عبارة SQL المقابلة لتعيين الأذونات (يمكن إلغاء الأذونات بعد نجاح الكشف والاسترداد).",
