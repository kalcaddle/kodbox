...
<li> تحديث: بعد التنزيل والتحميل وفك الضغط إلى مجلد اسم المكون الإضافي المقابل ؛</li>",
    ...
    "admin.storage.obsKeyDesc"       => "معرف مفتاح الوصول لحساب Huawei Cloud، يرجى إنشاؤه أو عرضه في [Console-My Credentials-API Credentials]",
    "admin.storage.obsSecretDesc"    => "سر الوصول إلى حساب Huawei Cloud، طريقة الحصول عليه هي نفسها المذكورة أعلاه",
    "admin.storage.bosKeyDesc"       => "معرف مفتاح الوصول لحساب Baidu Cloud، يرجى إنشائه أو عرضه في [Console-Security Authentication-Access Key]",
    "admin.storage.bosSecretDesc"    => "سر مفتاح الوصول لحساب Baidu Cloud، طريقة الحصول عليه هي نفسها المذكورة أعلاه",
