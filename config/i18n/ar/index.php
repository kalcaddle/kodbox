...
<li> نطاق IP: تطابق IP ضمن النطاق ؛ على سبيل المثال: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "سيقوم مفتاح تبديل قاعدة البيانات باستيراد البيانات الحالية للنظام إلى قاعدة البيانات الجديدة وتعيينها على أنها البيانات الافتراضية.<br> هل أنت متأكد أنك تريد تنفيذه؟",
    ...
    "admin.setting.recDescInfo1"     => "من خلال كتابة البيانات الموجودة في ملف قاعدة البيانات الاحتياطية إلى قاعدة البيانات الجديدة وتعيينها على أنها الإعداد الافتراضي للنظام ، يتم تحقيق استعادة البيانات.",
    "admin.setting.recDescInfo2"     => "سيتم إلحاق معلمات تكوين قاعدة البيانات الجديدة بملف تكوين النظام config / setting_user.php. إذا كان النظام غير طبيعي بعد تنفيذ الاسترداد ، يمكن إزالة الجزء الملحق من الملف دون التأثير على بيانات النظام السابقة.",
    "admin.setting.recDescInfo3"     => "تدعم هذه الوظيفة فقط معالجة بيانات النسخ الاحتياطي التي تم إنشاؤها بواسطة إدارة النسخ الاحتياطي للنظام ، ويجب معالجة قاعدة البيانات التي تم نسخها احتياطيًا بنفسك بطرق أخرى.",
...
<li> تحديث: بعد التنزيل والتحميل وفك الضغط إلى مجلد اسم المكون الإضافي المقابل ؛</li>",
    ...
    "admin.share.rptIfBatch"         => "هل انت متأكد من أنك تريد أن تفعل هذا؟",
