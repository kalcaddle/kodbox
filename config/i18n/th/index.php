...
<li> อัปเดต: หลังจากดาวน์โหลดอัปโหลดและเปิดเครื่องรูดไปยังโฟลเดอร์ชื่อปลั๊กอินที่เกี่ยวข้อง</li>",
    ...
    "admin.backup.optionLocation"    => "กรุณาสร้างพื้นที่เก็บข้อมูลใหม่สำหรับการสำรองไฟล์โดยเฉพาะ",
    "admin.backup.optionTips1"       => "การสำรองข้อมูลแบ่งออกเป็นสองส่วนคือการสำรองฐานข้อมูลและการสำรองไฟล์",
    "admin.backup.optionTips2"       => "การสำรองฐานข้อมูล: สร้างไฟล์ SQL จากเนื้อหาฐานข้อมูลและสำรองข้อมูลไปยังไดเร็กทอรีฐานข้อมูลของพื้นที่จัดเก็บเป้าหมาย ซึ่งเป็นพื้นที่จัดเก็บเริ่มต้นของระบบสำหรับฐานข้อมูลเท่านั้น",
    ...
    "admin.restore.recFileDesc2"     => "หมายเหตุ: การจำลองข้อมูลที่เกี่ยวข้องกับการคืนค่าจะขึ้นอยู่กับบันทึกไฟล์ของฐานข้อมูลปัจจุบัน ดังนั้น หากจำเป็นต้องติดตั้งระบบใหม่ จำเป็นต้องคืนค่าฐานข้อมูลก่อน",
