...
<li> ช่วง IP: ip ตรงกันภายในช่วงตัวอย่างเช่น 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "ตัวอย่างเช่นข้อมูลการกำหนดค่าฐานข้อมูลปัจจุบันคือ: ผู้ใช้: ทดสอบ; รหัสผ่าน : test123. เข้าสู่ระบบฐานข้อมูลโดยใช้บัญชี root และดำเนินการคำสั่ง SQL ที่สอดคล้องกันเพื่อตั้งค่าสิทธิ์ (สามารถเพิกถอนสิทธิ์ได้หลังจากผ่านการตรวจจับและการกู้คืนสำเร็จ)",
