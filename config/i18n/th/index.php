...
<li> อัปเดต: หลังจากดาวน์โหลดอัปโหลดและเปิดเครื่องรูดไปยังโฟลเดอร์ชื่อปลั๊กอินที่เกี่ยวข้อง</li>",
    ...
    "admin.storage.obsKeyDesc"       => "รหัสการเข้าถึงคีย์ของบัญชี Huawei Cloud โปรดสร้างหรือดูใน [คอนโซล-ข้อมูลรับรองของฉัน-ข้อมูลรับรอง API]",
    "admin.storage.obsSecretDesc"    => "เข้าถึงรหัสลับของบัญชี Huawei Cloud วิธีการรับจะเหมือนกับข้างต้น",
    "admin.storage.bosKeyDesc"       => "รหัสคีย์การเข้าถึงของบัญชี Baidu Cloud โปรดสร้างหรือดูใน [คีย์การตรวจสอบความปลอดภัยคอนโซล-การเข้าถึง]",
    "admin.storage.bosSecretDesc"    => "เข้าถึงรหัสลับของบัญชี Baidu Cloud วิธีการรับจะเหมือนกับข้างต้น",
