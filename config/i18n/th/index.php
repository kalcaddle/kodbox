...
<li> ช่วง IP: ip ตรงกันภายในช่วงตัวอย่างเช่น 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "สวิตช์ฐานข้อมูลจะนำเข้าข้อมูลปัจจุบันของระบบไปยังฐานข้อมูลใหม่และตั้งค่าเป็นค่าเริ่มต้น<br> คุณแน่ใจหรือไม่ว่าต้องการดำเนินการ",
    ...
    "admin.setting.recDescInfo1"     => "โดยการเขียนข้อมูลในไฟล์ฐานข้อมูลสำรองไปยังฐานข้อมูลใหม่และตั้งค่าเป็นค่าเริ่มต้นของระบบ การกู้คืนข้อมูลจะเกิดขึ้น",
    "admin.setting.recDescInfo2"     => "พารามิเตอร์การกำหนดค่าฐานข้อมูลใหม่จะถูกผนวกเข้ากับไฟล์การกำหนดค่าระบบ config/setting_user.php หากระบบผิดปกติหลังจากดำเนินการกู้คืนแล้ว",
    "admin.setting.recDescInfo3"     => "ฟังก์ชันนี้สนับสนุนเฉพาะการประมวลผลข้อมูลสำรองที่สร้างโดยการจัดการการสำรองข้อมูลของระบบ และฐานข้อมูลที่สำรองด้วยตัวเองควรได้รับการประมวลผลด้วยวิธีอื่น",
...
<li> อัปเดต: หลังจากดาวน์โหลดอัปโหลดและเปิดเครื่องรูดไปยังโฟลเดอร์ชื่อปลั๊กอินที่เกี่ยวข้อง</li>",
    ...
    "admin.share.rptIfBatch"         => "คุณแน่ใจหรือว่าต้องการทำเช่นนี้?",
