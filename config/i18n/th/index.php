...
<li> อัปเดต: หลังจากดาวน์โหลดอัปโหลดและเปิดเครื่องรูดไปยังโฟลเดอร์ชื่อปลั๊กอินที่เกี่ยวข้อง</li>",
    ...
    "admin.storage.ifDel"            => "คุณแน่ใจหรือไม่ว่าต้องการลบข้อมูลในที่เก็บข้อมูลปัจจุบัน?",
    ...
    "admin.storage.ifRmBakNow"       => "พื้นที่เก็บข้อมูลนี้มีข้อมูลสำรองอยู่ เราควรลบมันทิ้งเลยหรือไม่?",
    "admin.storage.moveErr"          => "ไม่สามารถเชื่อมต่อที่เก็บข้อมูลได้และการย้ายข้อมูลไม่เสร็จสมบูรณ์",
    "admin.storage.ifRmErrNow"       => "ไม่สามารถเชื่อมต่ออุปกรณ์จัดเก็บข้อมูลได้ และไม่สามารถทำการย้ายข้อมูลให้เสร็จสมบูรณ์ได้ เราควรลบข้อมูลนั้นโดยตรงเลยหรือไม่?",
    ...
    "admin.storage.remove"           => "ลบข้อมูลที่จัดเก็บ",
    ...
    "admin.backup.checkLog"          => "สำหรับรายละเอียดเพิ่มเติม โปรดดูบันทึก:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "การสำรองไฟล์จะทำงานทุกๆ นาที แนะนำให้ดำเนินการในช่วงเวลาที่ไม่ใช่เวลาทำงาน",
 ...
 post_max_size ต้องเริ่มต้นใหม่)",
    ...
    "admin.setting.downloadZipClientDesc" => "เว็บไซต์นั้นต้องสามารถเชื่อมต่อกับเครือข่ายภายนอกได้ หรือต้องใช้โปรโตคอล HTTPS",
    ...
    "explorer.zipClientLimit1"       => "หากไฟล์มีขนาดใหญ่กว่า 4GB การบีบอัดข้อมูลฝั่งผู้ใช้งานจะไม่สามารถทำได้ โปรดเลือกดาวน์โหลดเป็นชุด หรือใช้โปรแกรมไคลเอ็นต์แทน",
    "explorer.zipClientLimit2"       => "ไฟล์ที่มีขนาดใหญ่กว่า 4GB ไม่สามารถบีบอัดได้ที่ฝั่งโปรแกรมหลัก",
