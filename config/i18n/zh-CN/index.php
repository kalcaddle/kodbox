...
<li>IP区间段: ip在区间内则匹配;例如:192.168.1.1-192.168.200.255</li>",
    ...
    "admin.backup.optionLocation"    => "请新建一个存储专门用于文件备份",
    "admin.backup.optionTips1"       => "备份分为数据库备份和文件备份两部分。",
    "admin.backup.optionTips2"       => "数据库备份：将数据库内容生成SQL文件，备份至目标存储的database目录——仅数据库时为系统默认存储。",
    ...
    "admin.restore.recFileDesc2"     => "注意：还原所涉及的复制依赖于当前数据库的文件记录，因此，如果涉及系统重装，需要先进行数据库还原。",
