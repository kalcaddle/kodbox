...
<li> Dải IP: ip khớp trong dải; ví dụ: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Cơ sở dữ liệu chuyển đổi sẽ nhập dữ liệu hiện tại của hệ thống vào cơ sở dữ liệu mới và đặt nó làm mặc định.<br> Bạn có chắc chắn muốn thực hiện nó không?",
    ...
    "admin.setting.recDescInfo1"     => "Bằng cách ghi dữ liệu trong tệp cơ sở dữ liệu sao lưu vào cơ sở dữ liệu mới và đặt nó làm mặc định của hệ thống, việc khôi phục dữ liệu được thực hiện.",
    "admin.setting.recDescInfo2"     => "Các tham số cấu hình cơ sở dữ liệu mới sẽ được thêm vào tệp cấu hình hệ thống config / setting_user.php. Nếu hệ thống bất thường sau khi thực hiện khôi phục, có thể xóa phần nối thêm của tệp mà không ảnh hưởng đến dữ liệu hệ thống trước đó.",
    "admin.setting.recDescInfo3"     => "Chức năng này chỉ hỗ trợ xử lý dữ liệu sao lưu do hệ thống quản lý sao lưu tạo ra và cơ sở dữ liệu do chính bạn sao lưu sẽ được xử lý theo các cách khác.",
...
<li> Cập nhật: Sau khi tải xuống, tải lên và giải nén vào thư mục tên trình cắm tương ứng;</li>",
    ...
    "admin.share.rptIfBatch"         => "Bạn có chắc chắn muốn làm điều này?",
