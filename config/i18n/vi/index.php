...
<li> Cập nhật: Sau khi tải xuống, tải lên và giải nén vào thư mục tên trình cắm tương ứng;</li>",
    ...
    "admin.storage.ifDel"            => "Bạn có chắc chắn muốn xóa dữ liệu hiện tại không?",
    ...
    "admin.storage.ifRmBakNow"       => "Bộ nhớ này chứa dữ liệu sao lưu. Chúng ta có nên xóa nó ngay lập tức không?",
    "admin.storage.moveErr"          => "Không thể kết nối bộ lưu trữ và không thể hoàn tất quá trình di chuyển dữ liệu.",
    "admin.storage.ifRmErrNow"       => "Không thể kết nối thiết bị lưu trữ và quá trình di chuyển dữ liệu không thể hoàn tất. Chúng ta có nên xóa nó ngay lập tức không?",
    ...
    "admin.storage.remove"           => "Xóa bộ nhớ",
    ...
    "admin.backup.checkLog"          => "Để biết thêm chi tiết, vui lòng xem nhật ký:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "Quá trình sao lưu tập tin được thực hiện mỗi phút một lần; nên thực hiện việc này vào giờ nghỉ giữa giờ làm việc.",
 ...
 post_max_size, cần khởi động lại)",
    ...
    "admin.setting.downloadZipClientDesc" => "Nó cần có khả năng kết nối với mạng bên ngoài, hoặc trang web cần sử dụng HTTPS.",
    ...
    "common.code"                    => "mã số",
    "common.zoomout"                 => "Thu nhỏ",
    "common.zoomin"                  => "phóng to",
    ...
    "explorer.zipClientLimit1"       => "Nếu tệp tin có dung lượng lớn hơn 4GB, quá trình nén ở giai đoạn đầu sẽ không thể hoàn tất. Vui lòng chọn tải xuống theo từng đợt hoặc sử dụng ứng dụng khách.",
    "explorer.zipClientLimit2"       => "Các tệp có dung lượng lớn hơn 4GB không thể được nén ở giai đoạn đầu.",
