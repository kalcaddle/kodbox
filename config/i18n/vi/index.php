...
<li> Cập nhật: Sau khi tải xuống, tải lên và giải nén vào thư mục tên trình cắm tương ứng;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "ID khóa truy cập của tài khoản Huawei Cloud, vui lòng tạo hoặc xem nó trong [Console-My Credentials-API Credentials]",
    "admin.storage.obsSecretDesc"    => "Truy cập Key Secret của tài khoản Huawei Cloud, cách lấy cũng tương tự như trên",
    "admin.storage.bosKeyDesc"       => "ID khóa truy cập của tài khoản Baidu Cloud, vui lòng tạo hoặc xem nó trong [Khóa truy cập-Xác thực bảo mật bảng điều khiển]",
    "admin.storage.bosSecretDesc"    => "Truy cập Key Secret của tài khoản Baidu Cloud, cách lấy cũng tương tự như trên",
