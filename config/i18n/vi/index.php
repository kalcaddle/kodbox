...
<li> Cập nhật: Sau khi tải xuống, tải lên và giải nén vào thư mục tên trình cắm tương ứng;</li>",
    ...
    "admin.backup.optionLocation"    => "Vui lòng tạo một bộ lưu trữ mới dành riêng cho việc sao lưu tệp",
    "admin.backup.optionTips1"       => "Bản sao lưu được chia thành hai phần: sao lưu cơ sở dữ liệu và sao lưu tệp.",
    "admin.backup.optionTips2"       => "Sao lưu cơ sở dữ liệu: Tạo tệp SQL từ nội dung cơ sở dữ liệu và sao lưu vào thư mục cơ sở dữ liệu của bộ lưu trữ đích - bộ lưu trữ mặc định của hệ thống chỉ dành cho cơ sở dữ liệu.",
    ...
    "admin.restore.recFileDesc2"     => "Lưu ý: Việc sao chép dữ liệu trong quá trình khôi phục phụ thuộc vào các bản ghi tệp của cơ sở dữ liệu hiện tại. Do đó, nếu cần cài đặt lại hệ thống, bạn cần khôi phục cơ sở dữ liệu trước.",
