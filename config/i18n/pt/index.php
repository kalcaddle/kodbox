...
<li> Intervalo de IP: correspondências de ip dentro do intervalo; por exemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "A troca de banco de dados importará os dados atuais do sistema para o novo banco de dados e os definirá como padrão.<br> Tem certeza que deseja executá-lo?",
    ...
    "admin.setting.recDescInfo1"     => "Ao gravar os dados no arquivo de banco de dados de backup no novo banco de dados e defini-lo como o padrão do sistema, a recuperação dos dados é realizada.",
    "admin.setting.recDescInfo2"     => "Os novos parâmetros de configuração do banco de dados serão anexados ao arquivo de configuração do sistema config / setting_user.php. Se o sistema estiver anormal após a execução da recuperação, a parte anexada do arquivo pode ser removida sem afetar os dados anteriores do sistema.",
    "admin.setting.recDescInfo3"     => "Esta função suporta apenas o processamento dos dados de backup gerados pelo gerenciamento de backup do sistema, e o banco de dados cujo backup foi feito por você deve ser processado de outras maneiras.",
...
<li> Atualizar: Após baixar, carregue e descompacte para a pasta de nome do plug-in correspondente;</li>",
    ...
    "admin.share.rptIfBatch"         => "Você tem certeza de que quer fazer isso?",
