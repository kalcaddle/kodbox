...
<li> Intervalo de IP: correspondências de ip dentro do intervalo; por exemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "Por exemplo, as informações de configuração atuais do banco de dados são: Usuário: teste; Senha: test123. Efetue login no banco de dados usando a conta root e execute a instrução SQL correspondente para definir permissões (as permissões podem ser revogadas após a detecção ser aprovada e a recuperação bem-sucedida).",
