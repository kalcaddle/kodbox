...
<li> Atualizar: Após baixar, carregue e descompacte para a pasta de nome do plug-in correspondente;</li>",
    ...
    "admin.backup.errorDesc"         => "O banco de dados ou armazenamento está anormal, fazendo com que o backup seja abortado. Você pode clicar em [End] e depois fazer o backup manualmente.",
 ...
 post_max_size, precisa reiniciar)",
    ...
    "admin.setting.downloadZipLimit" => "Limite de download do pacote de pastas",
