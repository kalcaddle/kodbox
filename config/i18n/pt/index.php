...
<li> Atualizar: Após baixar, carregue e descompacte para a pasta de nome do plug-in correspondente;</li>",
    ...
    "admin.backup.optionLocation"    => "Por favor, crie um novo armazenamento especificamente para backup de arquivos",
    "admin.backup.optionTips1"       => "O backup é dividido em duas partes: backup de banco de dados e backup de arquivo.",
    "admin.backup.optionTips2"       => "Backup do banco de dados: gere um arquivo SQL a partir do conteúdo do banco de dados e faça backup dele no diretório do banco de dados do armazenamento de destino - o armazenamento padrão do sistema somente para o banco de dados.",
    ...
    "admin.restore.recFileDesc2"     => "Observação: a replicação envolvida na restauração depende dos registros de arquivo do banco de dados atual. Portanto, se envolver a reinstalação do sistema, você precisará restaurar o banco de dados primeiro.",
