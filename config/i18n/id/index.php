...
<li> Perbarui: Setelah mengunduh, unggah dan unzip ke folder nama plug-in yang sesuai;</li>",
    ...
    "admin.backup.optionLocation"    => "Silakan buat penyimpanan baru khusus untuk pencadangan file",
    "admin.backup.optionTips1"       => "Cadangan dibagi menjadi dua bagian: cadangan basis data dan cadangan file.",
    "admin.backup.optionTips2"       => "Pencadangan basis data: Hasilkan file SQL dari konten basis data dan cadangkan ke direktori basis data penyimpanan target - penyimpanan default sistem hanya untuk basis data.",
    ...
    "admin.restore.recFileDesc2"     => "Catatan: Replikasi yang terlibat dalam pemulihan bergantung pada rekaman berkas basis data saat ini. Oleh karena itu, jika melibatkan instalasi ulang sistem, basis data perlu dipulihkan terlebih dahulu.",
