...
<li> Rentang IP: kecocokan ip dalam rentang tersebut; misalnya: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Sakelar basis data akan mengimpor data sistem saat ini ke dalam basis data baru dan menetapkannya sebagai default.<br> Apakah Anda yakin ingin mengeksekusinya?",
    ...
    "admin.setting.recDescInfo1"     => "Dengan menulis data dalam file database cadangan ke database baru dan menetapkannya sebagai default sistem, pemulihan data terwujud.",
    "admin.setting.recDescInfo2"     => "Parameter konfigurasi database baru akan ditambahkan ke file konfigurasi sistem config/setting_user.php. Jika sistem tidak normal setelah pemulihan dijalankan, bagian file yang ditambahkan dapat dihapus tanpa mempengaruhi data sistem sebelumnya.",
    "admin.setting.recDescInfo3"     => "Fungsi ini hanya mendukung pemrosesan data cadangan yang dihasilkan oleh manajemen pencadangan sistem, dan basis data yang dicadangkan sendiri harus diproses dengan cara lain.",
