...
<li> Perbarui: Setelah mengunduh, unggah dan unzip ke folder nama plug-in yang sesuai;</li>",
    ...
    "admin.backup.errorDesc"         => "Basis data atau penyimpanan tidak normal, menyebabkan pencadangan dibatalkan. Anda dapat mengklik [End] lalu mencadangkan secara manual.",
 ...
 post_max_size, perlu memulai ulang)",
    ...
    "admin.setting.downloadZipLimit" => "Batas unduhan paket folder",
