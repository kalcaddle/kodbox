...
<li> Perbarui: Setelah mengunduh, unggah dan unzip ke folder nama plug-in yang sesuai;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Akses ID Kunci akun Huawei Cloud, silakan buat atau lihat di [Konsol-Kredensial Saya-Kredensial API]",
    "admin.storage.obsSecretDesc"    => "Akses Key Secret akun Huawei Cloud, cara mendapatkannya sama seperti di atas",
    "admin.storage.bosKeyDesc"       => "Akses ID Kunci akun Baidu Cloud, silakan buat atau lihat di [Kunci Akses Otentikasi Keamanan Konsol]",
    "admin.storage.bosSecretDesc"    => "Akses Kunci Rahasia akun Baidu Cloud, cara mendapatkannya sama seperti di atas",
