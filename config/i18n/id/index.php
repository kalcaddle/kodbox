...
<li> Perbarui: Setelah mengunduh, unggah dan unzip ke folder nama plug-in yang sesuai;</li>",
    ...
    "admin.storage.ifDel"            => "Apakah Anda yakin ingin menghapus penyimpanan saat ini?",
    ...
    "admin.storage.ifRmBakNow"       => "Penyimpanan ini berisi data cadangan. Haruskah kita menghapusnya langsung?",
    "admin.storage.moveErr"          => "Penyimpanan tidak dapat dihubungkan dan migrasi data tidak dapat diselesaikan.",
    "admin.storage.ifRmErrNow"       => "Penyimpanan tidak dapat terhubung, dan migrasi data tidak dapat diselesaikan. Haruskah kita menghapusnya langsung?",
    ...
    "admin.storage.remove"           => "Hapus penyimpanan",
    ...
    "admin.backup.checkLog"          => "Untuk detailnya, silakan lihat log:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "Tugas pencadangan file berjalan sekali per menit; disarankan untuk menjalankannya di luar jam kerja.",
 ...
 post_max_size, perlu memulai ulang)",
    ...
    "admin.setting.downloadZipClientDesc" => "Situs tersebut harus dapat terhubung ke jaringan eksternal, atau situs tersebut harus menggunakan HTTPS.",
    ...
    "common.code"                    => "kode",
    "common.zoomout"                 => "Menyusut",
    "common.zoomin"                  => "memperbesar",
    ...
    "explorer.zipClientLimit1"       => "Jika ukuran file lebih besar dari 4GB, kompresi front-end tidak dapat diselesaikan. Silakan pilih untuk mengunduh secara bertahap atau gunakan aplikasi klien.",
    "explorer.zipClientLimit2"       => "File yang berukuran lebih besar dari 4GB tidak dapat dikompresi di sisi depan.",
