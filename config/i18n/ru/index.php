...
<li> Обновление: после загрузки загрузите и разархивируйте в папку с именем соответствующего плагина;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Получите доступ к идентификатору ключа учетной записи Huawei Cloud. Создайте или просмотрите его в [Консоль-Мои учетные данные-API Credentials].",
    "admin.storage.obsSecretDesc"    => "Доступ к секретному ключу учетной записи Huawei Cloud, метод получения такой же, как указано выше.",
    "admin.storage.bosKeyDesc"       => "Идентификатор ключа доступа к учетной записи Baidu Cloud. Создайте или просмотрите его в [Консоль-Аутентификация безопасности-Ключ доступа]",
    "admin.storage.bosSecretDesc"    => "Доступ к секретному ключу учетной записи Baidu Cloud, метод получения такой же, как указано выше.",
