...
<li> Диапазон IP-адресов: IP соответствует диапазону; например: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Переключатель базы данных импортирует текущие данные системы в новую базу данных и установит их по умолчанию.<br> Вы уверены, что хотите его выполнить?",
    ...
    "admin.setting.recDescInfo1"     => "Восстановление данных осуществляется путем записи данных из файла резервной базы данных в новую базу данных и установки ее в качестве системы по умолчанию.",
    "admin.setting.recDescInfo2"     => "Новые параметры конфигурации базы данных будут добавлены к файлу конфигурации системы config / setting_user.php. Если система работает ненормально после выполнения восстановления, добавленную часть файла можно удалить, не затрагивая предыдущие системные данные.",
    "admin.setting.recDescInfo3"     => "Эта функция поддерживает только обработку данных резервного копирования, созданных системой управления резервным копированием, а база данных, резервная копия которой была создана вами, должна обрабатываться другими способами.",
...
<li> Обновление: после загрузки загрузите и разархивируйте в папку с именем соответствующего плагина;</li>",
    ...
    "admin.share.rptIfBatch"         => "Вы уверены, что хотите это сделать?",
