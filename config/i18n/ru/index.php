...
<li> Обновление: после загрузки загрузите и разархивируйте в папку с именем соответствующего плагина;</li>",
    ...
    "admin.backup.optionLocation"    => "Пожалуйста, создайте новое хранилище специально для резервного копирования файлов.",
    ...
    "admin.backup.optionTips2"       => "Резервное копирование базы данных: создание файла SQL из содержимого базы данных и его резервное копирование в каталог базы данных целевого хранилища — системного хранилища по умолчанию, предназначенного только для базы данных.",
    ...
    "admin.restore.recFileDesc2"     => "Примечание: Репликация, выполняемая при восстановлении, зависит от файловых записей текущей базы данных. Поэтому, если требуется переустановка системы, сначала необходимо восстановить базу данных.",
