...
<li> Обновление: после загрузки загрузите и разархивируйте в папку с именем соответствующего плагина;</li>",
    ...
    "admin.backup.errorDesc"         => "База данных или хранилище неисправны, что приводит к прерыванию резервного копирования. Вы можете нажать [Конец] и выполнить резервное копирование вручную.",
