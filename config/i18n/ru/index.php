...
<li> Диапазон IP-адресов: IP соответствует диапазону; например: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo32"    => "Например, текущая информация о конфигурации базы данных: Пользователь: test; Пароль: test123. Войдите в базу данных, используя учетную запись root, и выполните соответствующий оператор SQL, чтобы установить разрешения (разрешения могут быть отозваны после успешного обнаружения и восстановления).",
