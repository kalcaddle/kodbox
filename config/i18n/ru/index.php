...
<li> Обновление: после загрузки загрузите и разархивируйте в папку с именем соответствующего плагина;</li>",
    ...
    "admin.backup.checkLog"          => "Подробности см. в журнале:<br/> data/temp/log/backup/current_date__log.php",
 ...
 post_max_size, нужно перезагрузить)",
    ...
    "admin.setting.downloadZipClientDesc" => "Оно должно иметь возможность подключаться к внешней сети, или же сайт должен использовать протокол HTTPS.",
    ...
    "explorer.zipClientLimit2"       => "Файлы размером более 4 ГБ не могут быть сжаты на начальном этапе.",
