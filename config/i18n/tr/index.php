...
<li> Güncelleme: İndirdikten sonra, ilgili eklenti adı klasörüne yükleyin ve açın;</li>",
    ...
    "admin.storage.obsKeyDesc"       => "Huawei Cloud hesabının Erişim Anahtarı Kimliği, lütfen bunu [Konsol-Kimlik Bilgilerim-API Kimlik Bilgileri]'nde oluşturun veya görüntüleyin.",
    "admin.storage.obsSecretDesc"    => "Huawei Cloud hesabının Erişim Anahtarı Sırrı, elde etme yöntemi yukarıdakiyle aynıdır",
    "admin.storage.bosKeyDesc"       => "Baidu Cloud hesabının Erişim Anahtarı Kimliği, lütfen bunu [Konsol-Güvenlik Kimlik Doğrulaması-Erişim Anahtarı]'nda oluşturun veya görüntüleyin.",
    "admin.storage.bosSecretDesc"    => "Baidu Bulut hesabının Anahtar Sırrına Erişim, elde etme yöntemi yukarıdakiyle aynıdır",
