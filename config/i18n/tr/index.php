...
<li> Güncelleme: İndirdikten sonra, ilgili eklenti adı klasörüne yükleyin ve açın;</li>",
    ...
    "admin.backup.optionLocation"    => "Lütfen dosya yedekleme için özel olarak yeni bir depolama alanı oluşturun",
    "admin.backup.optionTips1"       => "Yedekleme iki bölüme ayrılmıştır: veritabanı yedekleme ve dosya yedekleme.",
    "admin.backup.optionTips2"       => "Veritabanı yedekleme: Veritabanı içeriğinden bir SQL dosyası oluşturun ve bunu hedef depolama alanının veritabanı dizinine yedekleyin - sistemin yalnızca veritabanı için varsayılan depolama alanı.",
    ...
    "admin.restore.recFileDesc2"     => "Not: Geri yükleme işleminde kullanılan çoğaltma, mevcut veritabanının dosya kayıtlarına bağlıdır. Bu nedenle, sistem yeniden yüklemesi gerekiyorsa, önce veritabanını geri yüklemeniz gerekir.",
