...
<li> IP aralığı: ip, aralık dahilinde eşleşir; örneğin: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.ifSaveDb"         => "Veritabanı anahtarı, sistemin mevcut verilerini yeni veritabanına aktaracak ve varsayılan olarak ayarlayacaktır.<br> Yürütmek istediğinizden emin misiniz?",
    ...
    "admin.setting.recDescInfo1"     => "Yedek veritabanı dosyasındaki veriler yeni veritabanına yazılarak ve sistem varsayılanı olarak ayarlanarak veri kurtarma gerçekleştirilir.",
    "admin.setting.recDescInfo2"     => "Yeni veritabanı yapılandırma parametreleri sistem yapılandırma dosyasına config/setting_user.php eklenecektir.Kurtarma yürütüldükten sonra sistem anormal ise, dosyanın eklenen kısmı önceki sistem verilerini etkilemeden kaldırılabilir.",
    "admin.setting.recDescInfo3"     => "Bu işlev yalnızca sistem yedekleme yönetimi tarafından oluşturulan yedekleme verilerinin işlenmesini destekler ve sizin tarafınızdan yedeklenen veritabanı başka şekillerde işlenmelidir.",
...
<li> Güncelleme: İndirdikten sonra, ilgili eklenti adı klasörüne yükleyin ve açın;</li>",
    ...
    "admin.share.rptIfBatch"         => "Bunu yapmak istediğinden emin misin?",
