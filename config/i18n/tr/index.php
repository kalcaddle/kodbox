...
<li> Güncelleme: İndirdikten sonra, ilgili eklenti adı klasörüne yükleyin ve açın;</li>",
    ...
    "admin.storage.ifMove"           => "Bu depolama, [1] ağ diski dosyalarını içerir ve mevcut varsayılan depolamaya taşınacaktır. Devam etmek istiyor musunuz?",
    ...
    "admin.storage.sysFile"          => "Ağ disk dosyaları: kişisel alan ve bölümler altındaki dosyalar",
    ...
    "admin.backup.errorDesc"         => "Veritabanı veya depolama anormal, bu da yedeklemenin iptal edilmesine neden oluyor. [Son]'a tıklayıp manuel olarak yedekleyebilirsiniz.",
 ...
 post_max_size, yeniden başlatmanız gerekiyor)",
    ...
    "admin.setting.downloadZipLimit" => "Klasör paketi indirme sınırı",
