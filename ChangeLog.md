...
- 文件管理
	...
	- 物理路径文档支持设置标签(标签label显示/右键标签设置/属性面板标签显示及设置/权限处理; 物理路径/io路径/kod路径/内部协作分享)
	...
	- 复制pc文件文件夹/屏幕截图; 支持粘贴到文件夹支持用户部门更目录下(之前仅支持子目录)
...
- 其他优化
	...
	- 细节优化: 文件属性-下载链接下载文件时文件名兼容优化;文件列表分组-折叠状态自动记录;
