...
(function(){
	// G2卡死问题; iOS15-Safari15,MacOS15-Safari:15;(4.1.27 2021.9.18 尚未修复) https://github.com/antvis/G2/releases   
	// issue:https://github.com/antvis/G2/issues/3635, https://github.com/antvis/G2/issues/3556
	
	// var system = UAParser.getOS(navigator.userAgent);
	// var browser= UAParser.getBrowser(navigator.userAgent),support = true;
	// if( system.name == 'iOS' && parseFloat(system.version) >= 15.0){support = false;}
	// if( browser.name == 'Safari' && parseFloat(browser.version) >= 15.0){support = false;}
	// if(!support){G2.Chart.prototype.render = function(){};}
	
	// G2.Global.fontFamily = 'BlinkMacSystemFont, "Segoe UI", Roboto,"Helvetica Neue", Helvetica, "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei",SimSun, "sans-serif"';
