...
hljs.highlightElement = hljs.highlightBlock;
hljs.highlight = function(code,options){ // 确保支持该高亮语言;
	var language = hljsHighlightAll.indexOf(options.language) !== -1 ? options.language : 'ini';
	return hljsHighlight.apply(hljs,[language,code]);
}