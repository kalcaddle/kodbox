...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='通用评论表';

DROP TABLE IF EXISTS `comment_meta`;
CREATE TABLE `comment_meta` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `commentID` bigint(20) unsigned NOT NULL COMMENT '评论id',
  `key` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '字段key',
  `value` text CHARACTER SET utf8 NOT NULL COMMENT '字段值',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  ...
  KEY `key` (`key`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='评论表扩展字段';
...
CREATE TABLE `comment_praise` (
  ...
  KEY `modifyTime` (`modifyTime`),
  KEY `createTime` (`createTime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='评论点赞表';

DROP TABLE IF EXISTS `group`;
CREATE TABLE `group` (
  `groupID` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '群组id',
  `name` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '群组名',
  `parentID` bigint(20) unsigned NOT NULL COMMENT '父群组id',
  `parentLevel` varchar(1000) CHARACTER SET utf8 NOT NULL COMMENT '父路径id; 例如:  ,2,5,10,',
  `extraField` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '扩展字段',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='群组表';

DROP TABLE IF EXISTS `group_meta`;
CREATE TABLE `group_meta` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `groupID` bigint(20) unsigned NOT NULL COMMENT '部门id',
  `key` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '存储key',
  `value` text CHARACTER SET utf8 NOT NULL COMMENT '对应值',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  `modifyTime` int(11) unsigned NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`id`),
  ...
  KEY `groupID` (`groupID`),
  KEY `key` (`key`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户数据扩展表';

DROP TABLE IF EXISTS `io_file`;
CREATE TABLE `io_file` (
  `fileID` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `name` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '文件名',
  ...
  `hashSimple` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '文件简易hash(不全覆盖)；hashSimple',
  `hashMd5` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '文件hash, md5',
  ...
  KEY `hashMd5` (`hashMd5`),
  KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文档存储表';
...
CREATE TABLE `io_file_contents` (
  ...
  `content` mediumtext CHARACTER SET utf8 NOT NULL COMMENT '文本文件内容,最大16M',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`fileID`),
  KEY `createTime` (`createTime`),
  KEY `content` (`content`(333))
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文件id';
...
CREATE TABLE `io_file_meta` (
  ...
  KEY `fileID` (`fileID`),
  KEY `key` (`key`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文件扩展表';

DROP TABLE IF EXISTS `io_source`;
CREATE TABLE `io_source` (
  `sourceID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `sourceHash` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT ' id的hash',
  ...
  `name` varchar(256) CHARACTER SET utf8 NOT NULL COMMENT '文件名',
  `fileType` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '文件扩展名，文件夹则为空',
  `parentID` bigint(20) unsigned NOT NULL COMMENT '父级资源id，为0则为部门或用户根文件夹，添加用户部门时自动新建',
  `parentLevel` varchar(2000) CHARACTER SET utf8 NOT NULL COMMENT '父路径id; 例如:  ,2,5,10,',
  ...
  KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文档数据表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文档权限表';
...
CREATE TABLE `io_source_event` (
  ...
  `type` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '事件类型',
  `desc` text CHARACTER SET utf8 NOT NULL COMMENT '数据详情，根据type内容意义不同',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `sourceID` (`sourceID`),
  ...
  KEY `eventType` (`type`),
  KEY `createTime` (`createTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文档事件表';
...
CREATE TABLE `io_source_history` (
  ...
  `detail` varchar(1024) CHARACTER SET utf8 NOT NULL COMMENT '版本描述',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  `modifyTime` int(11) unsigned NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`id`),
  KEY `sourceID` (`sourceID`),
  ...
  KEY `fileID` (`fileID`),
  KEY `createTime` (`createTime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文档历史记录表';
...
CREATE TABLE `io_source_meta` (
  ...
  KEY `sourceID` (`sourceID`),
  KEY `key` (`key`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文档扩展表';
...
CREATE TABLE `io_source_recycle` (
  ...
  `sourceID` bigint(20) unsigned NOT NULL COMMENT '文档id',
  `userID` bigint(20) unsigned NOT NULL COMMENT '操作者id',
  `parentLevel` varchar(2000) CHARACTER SET utf8 NOT NULL COMMENT '文档上层关系;冗余字段,便于统计回收站信息',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `sourceID` (`sourceID`),
  KEY `userID` (`userID`),
  ...
  KEY `targetType` (`targetType`),
  KEY `targetID` (`targetID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文档回收站';

DROP TABLE IF EXISTS `share`;
CREATE TABLE `share` (
  `shareID` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `title` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '分享标题',
  `shareHash` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'shareid',
  `userID` bigint(20) unsigned NOT NULL COMMENT '分享用户id',
  `sourceID` bigint(20) NOT NULL COMMENT '用户数据id',
  `sourcePath` varchar(1024) CHARACTER SET utf8 NOT NULL COMMENT '分享文档路径',
  `url` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '分享别名,替代shareHash',
  `isLink` tinyint(4) unsigned NOT NULL COMMENT '是否外链分享；默认为0',
  `isShareTo` tinyint(4) unsigned NOT NULL COMMENT '是否为内部分享；默认为0',
  `password` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '访问密码,为空则无密码',
  ...
  `options` varchar(1000) CHARACTER SET utf8 NOT NULL COMMENT 'json 配置信息;是否可以下载,是否可以上传等',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  `modifyTime` int(11) unsigned NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`shareID`),
  KEY `userID` (`userID`),
  ...
  KEY `url` (`url`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='分享数据表';
...
CREATE TABLE `share_report` (
  ...
  `desc` text CHARACTER SET utf8 NOT NULL COMMENT '举报原因（其他）描述',
  ...
  KEY `modifyTime` (`modifyTime`),
  KEY `createTime` (`createTime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='分享举报表';
...
CREATE TABLE `share_to` (
  ...
  KEY `authDefine` (`authDefine`),
  KEY `authID` (`authID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='分享给指定用户(协作)';

DROP TABLE IF EXISTS `system_log`;
CREATE TABLE `system_log` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `sessionID` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT 'session识别码，用于登陆时记录ip,UA等信息',
  `userID` bigint(20) unsigned NOT NULL COMMENT '用户id',
  `type` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '日志类型',
  `desc` text CHARACTER SET utf8 NOT NULL COMMENT '详情',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `userID` (`userID`),
  KEY `type` (`type`),
...
CREATE TABLE `system_option` (
  ...
  `type` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '配置类型',
...
CREATE TABLE `system_session` (
  ...
  `sign` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT 'session标识',
  `userID` bigint(20) unsigned NOT NULL COMMENT '用户id',
  `content` text CHARACTER SET utf8 NOT NULL COMMENT 'value',
  ...
  KEY `expires` (`expires`),
  KEY `modifyTime` (`modifyTime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='session';

DROP TABLE IF EXISTS `user`;
CREATE TABLE `user` (
  `userID` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `name` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '登陆用户名',
  `roleID` int(11) unsigned NOT NULL COMMENT '用户角色',
  `email` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '邮箱',
  `phone` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '手机',
...
CREATE TABLE `user_fav` (
  ...
  `name` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '收藏名称',
  `path` varchar(2048) CHARACTER SET utf8 NOT NULL COMMENT '收藏路径,tag时则为sourceID',
  `type` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT 'source/path',
  `sort` int(11) unsigned NOT NULL COMMENT '排序',
  `modifyTime` int(11) unsigned NOT NULL COMMENT '最后修改时间',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  ...
  KEY `path` (`path`(333)),
  KEY `type` (`type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户文档标签表';
...
CREATE TABLE `user_group` (
  ...
  KEY `sort` (`sort`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户群组关联表(一对多)';
...
CREATE TABLE `user_option` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `userID` bigint(20) unsigned NOT NULL COMMENT '用户id',
  `type` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '配置类型,全局配置类型为空,编辑器配置type=editor',
  `key` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '配置key',
  `value` text CHARACTER SET utf8 NOT NULL COMMENT '配置值',
  `createTime` int(11) unsigned NOT NULL COMMENT '创建时间',
  `modifyTime` int(11) unsigned NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`id`),
  ...
  KEY `key` (`key`),
  KEY `type` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户数据配置表';
