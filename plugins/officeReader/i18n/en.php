...
return array(
	...
	'officeReader.main.needNetwork'				=> "The kod server needs to be on the Internet, and it is a domain name",
	'officeReader.main.tryAgain'				=> ", please try opening again!",

	'officeReader.officeJs.name'				=> "Local",
	'officeReader.officeJs.desc'				=> "Through the front-end way to read the file content and display, it has the advantages of high speed, no networking and so on<br/> the disadvantage is that it supports few formats and hardly supports any styles<br/> if it's just a simple view, you might as well open it.</div>",
