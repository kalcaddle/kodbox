...
return array(
	...
	'officeReader.main.needNetwork'				=> "kod服务器需在外网，且为域名访问",
	'officeReader.main.tryAgain'				=> "，请尝试重新打开！",


	"officeReader.officeJs.name"				=> "本地解析",
	"officeReader.officeJs.desc"				=> "<div class='mt-5'>通过前端方式解析文件内容并显示，具有速度快、无需联网等优点。<br/>缺点是支持格式较少，几乎不支持任何样式。<br/>如果只是简单查看，不妨开启一试。</div>",

	"officeReader.officeLive.apiServer"			=> "服务器接口",
	"officeReader.officeLive.apiServerDesc"		=> "<div class='can-select pt-10'>
		预览服务器的地址，必须要office所在服务器能访问到kod<br/>可以使用第三方的服务，或微软官方的接口<br/><code style='color:#c7254e'>kod服务器必须要在外网,且需要域名访问</code><br/><br/>
