...
return array(
    ...
    "officeViewer.main.invalidType"  => "Предварительный просмотр этого файла с помощью текущего способа невозможен. Пожалуйста, выберите другой способ его открытия!",
    "officeViewer.main.invalidUrl"   => "Неверный адрес запроса. Пожалуйста, попробуйте открыть запрос заново или выбрать другой способ!",
    ...
    "officeViewer.officeLive.desc"   => "<div style='margin-top:3px;'>Предварительный просмотр файлов осуществляется путем анализа файлов с использованием служб Microsoft Office (через внешние ссылки на файлы).<br/><code style='color:#c7254e'>服务器需在外网，且为域名访问；可能导致文件泄露，请谨慎启用</code><br>Пользователи интрасети могут настроить это самостоятельно; <a href='https://kodcloud.com/help/show-5.html' target='_blank'>узнайте больше.</a></div>",
    ...
    "officeViewer.yzOffice.desc"     => "<div style='margin-top:3px;'>Файл обрабатывается с помощью сервиса Yongzhong Office (файл будет загружен на его сервер) для обеспечения предварительного просмотра.<br><code style='color:#c7254e'>服务器需能访问外网；可能导致文件泄露，请谨慎启用</code></div>",
