...
return array(
    ...
    "officeViewer.main.invalidType"  => "This file cannot be previewed using the current method. Please choose another method to open it!",
    "officeViewer.main.invalidUrl"   => "Invalid request address. Please try reopening or choosing another method!",
    ...
    "officeViewer.officeLive.desc"   => "<div style='margin-top:3px;'>File preview is achieved by parsing files using Microsoft Office services (through external file links).<br/><code style='color:#c7254e'>服务器需在外网，且为域名访问；可能导致文件泄露，请谨慎启用</code><br>Users on the intranet can set it up themselves; <a href='https://kodcloud.com/help/show-5.html' target='_blank'>learn more.</a></div>",
    ...
    "officeViewer.yzOffice.desc"     => "<div style='margin-top:3px;'>The file is parsed using Yongzhong Office service (the file will be uploaded to its server) to enable file preview.<br><code style='color:#c7254e'>服务器需能访问外网；可能导致文件泄露，请谨慎启用</code></div>",
